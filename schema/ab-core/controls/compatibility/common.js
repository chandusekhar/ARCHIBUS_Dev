/******************************************************************
	...
	YS(2008-12-17): reimplement $() by using Ext.get() API to avoid self-close 
	Element issues (e.g. <span id="myId"/> then $('myId').innerHTML will throw a fata JS error)
 ******************************************************************/
/*************Debug flag***********************/
 ...
 * 
 * TODO: cover arrays and objects with different numbers of properties.
 */
...
//////////////////////////////////////////////////////////////////////////
// make safe sql string - replace special characters

function convert2SafeSqlString(fieldValue){
	if (valueExistsNotEmpty(fieldValue)) {
		// replace aphostrophe
		fieldValue = fieldValue.replace(/\'/g, "\'\'");
	}
