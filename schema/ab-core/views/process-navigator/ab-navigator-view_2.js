...
Ab.navigator.Toolbar = Ab.view.Component.extend({
    ...
    doLayout: function() {
		...
		jQuery('div').find('#mainToolbar').append(
			'<div class="navigatorToolbar"><a id="mainToolbar_title" href="' + titleLink + '"></a></div>');
	...
	getMenuContainer: function() {
		var tblHTML = 
			...
			'<tr><td><a class="hovertip_target" id="titleBarUserLink">' + View.user.name + '<b class="caret"></b></a></td>' +
	...
	getMenuTooltip: function() {
		...
		var tblHTML = '<div class="hovertip" id="userOptionsContainer" target="titleBarUserLink">' +
			...
			'<tr><td>' + View.project.title + '</td></tr>' + '<tr><td>' + View.getLocalizedString(this.z_PROJECT_LABEL) + '</td></tr>' +
			'<tr><td>' + View.user.role + '</td></tr>' + '<tr><td>' + View.getLocalizedString(this.z_ROLE_LABEL) + '</td></tr>' +
			'<tr><td>' + View.buildNumber + '</td></tr>' + '<tr><td>' + View.getLocalizedString(this.z_VERSION_LABEL) + '</td></tr>' +
		...
		if (charCode == 13) {
			...
			if (searchText.length > 0) {
				...
				View.openDialog('ab-navigator-view-search.axvw', null, false, {
					...
					searchParameters: taskTitleColumn + ";" + processesTitleColumn + ";" + activitiesTitleColumn + ";" + productsTitleColumn + ";" + searchText
				});
			}
		}
	},
