  ...
  /**
    ...
    render: function() {
        ...
        if(this.root.children[0] && this.root.children[0].treeControl && this.root.children[0].treeControl.config['controlType']=='table'){
        	this.attachListenerToRootByType('button');
        	this.attachListenerToRootByType('image');
        }        
        this._hasEvents = true;
    },

    attachListenerToRootByType: function(type){
    	var elements = Ext.query('.treeTable .' + type, this.root.children[0].getDivEl());
    	for(var k=0; k<elements.length; k++){
    		...
    		if (valueExists(element) && element.nodeType != 3) {
    			...
    			this.attachListenerToElement(listenerName, element, row, panel, node);			
    		}	
    	}    	
    },
