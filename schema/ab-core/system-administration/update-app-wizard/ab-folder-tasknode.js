 ...
 */
YAHOO.widget.TaskNode = function(oData, oParent, expanded, checked, geocode) {
    ...
    if (oData) { 
        this.init(oData, oParent, expanded, geocode);
        this.setUpLabel(oData);
        this.setUpCheck(checked);
		this.setUpGeocode(geocode);
    }
...
YAHOO.extend(YAHOO.widget.TaskNode, YAHOO.widget.TextNode, {
    ...
    checked: false,
	/**
	 * true is this element have geocoding information, false if not
	 */
	geocode: true,
    /**
     * checkState
	...
	setUpGeocode: function(geocode){
		if(!geocode && geocode == false){
	...
	getGeocodeId: function(){
		return "ygtvgeocode" + this.index;
	},
    /**
    ...
    getNodeHtml: function() { 
        ...
        sb[sb.length] = '</td>';
		sb[sb.length] = '<td';
		sb[sb.length] = ' id="'+this.getGeocodeId()+'"';
		sb[sb.length] = ' class="'+ this.getGeocodeStyle()+'" >';
		sb[sb.length] = '<div class="ygtvspacer"></div></td>'
        sb[sb.length] = '</tr>';
        sb[sb.length] = '</table>';
