var energyBillVsMeterReadingsController = View.createController('energyBillVsMeterReadings',{
	...
	afterInitialDataFetch: function() {	
		...
		var vn_id = this.openerRecord.getValue('bill_archive.vn_id');
		var bill_id = this.openerRecord.getValue('bill_archive.bill_id');
		var bill_line_id = "";
		if (this.table_name == 'bill_line_archive') {
			bill_line_id = this.openerRecord.getValue('bill_line_archive.bill_line_id');
		}
		var groupField = "";
		var groupFieldValue = "";
	...
	energyBillVsMeterReadings_gridMeters_onShowReadings:function(row) {
		...
		var date_service_start = this.openerRecord.getValue('bill_archive.date_service_start');
		var date_service_end = this.openerRecord.getValue('bill_archive.date_service_end');
