...
var abCompRptRegLvlLocController = View.createController('abCompRptRegLvlLocController', {
	...
	afterViewLoad : function() {
		...
		//set line chart control properites
		...
		//add permanentParameter to avoid no value item in the x-axis
	...
	openPopUpView: function(ob,control) {
		...
		var restriction = " cost_total>0 and "+this.getPopUpSqlField(control.firstGroupField.name)+this.getPopUpSqlClauseByValue(ob.selectedChartData['regloc.firstGroupField']);
