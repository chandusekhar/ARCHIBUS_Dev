 ...
 * @author Guo Jiangtao
 */
var abCompRptRegLvlPrgController = View.createController('abCompRptRegLvlPrgController', {
	...
	afterViewLoad : function() {
		...
		chart.firstGroupFieldDef = 'reqTypeFieldDef';
		chart.secondGroupField = {
			'name' : 'comp_level',
			'title' : getMessage('secondGroupFieldTitle')
		};
		chart.firstGroupSortField = chart.firstGroupField;
