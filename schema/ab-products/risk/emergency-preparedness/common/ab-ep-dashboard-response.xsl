					...
					<xsl:for-each select="/*/afmAction">
						...
						<tr>
							<xsl:if test="position() = 1">
								<td colspan="2"><span translatable="true">First Responder and EMT Information</span></td><tr></tr>
							</xsl:if>

							<xsl:if test="position() = 3">
								<td colspan="2"><br /><span translatable="true">Containment Information</span></td><tr></tr>
							</xsl:if>

							<xsl:if test="position() = 4">
								<td colspan="2"><br /><span translatable="true">Employee Information</span></td><tr></tr>
							</xsl:if>

							<xsl:if test="position() = 5">
								<td colspan="2"><br /><span translatable="true">Recovery Team Information</span></td><tr></tr>
							</xsl:if>
