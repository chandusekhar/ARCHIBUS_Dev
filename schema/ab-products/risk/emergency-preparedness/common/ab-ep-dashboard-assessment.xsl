							...
							<xsl:for-each select="/*/afmAction">
								...
								<tr>
									<xsl:if test="position() = 1">
										<td colspan="2"><span translatable="true">Employee Assessment Information</span></td><tr></tr>
									</xsl:if>

									<xsl:if test="position() = 7">
										<td colspan="2"><br /><span translatable="true">Facility Assessment Information</span></td><tr></tr>
									</xsl:if>

									<xsl:if test="position() = 11">
										<td colspan="2"><br /><span translatable="true">Management Situation Reports</span></td><tr></tr>
									</xsl:if>
