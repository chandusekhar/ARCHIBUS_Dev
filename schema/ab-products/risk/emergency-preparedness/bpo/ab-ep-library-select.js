...
var abCompDocLibSelectController = View.createController('abCompDocLibSelectController',{
	...
	//list box options 
	listOptions: new Array("all","location","equipment","lease"),
	...
	*/
	initialListOptionRestrictions: function(){ 		
		this.listOptionRestrictions[0] = " 0=0 ";
		this.listOptionRestrictions[1] = " (docs_assigned.state_id IS NOT NULL OR docs_assigned.city_id IS NOT NULL OR docs_assigned.site_id IS NOT NULL OR docs_assigned.pr_id IS NOT NULL OR docs_assigned.bl_id IS NOT NULL) ";
		this.listOptionRestrictions[2] = " docs_assigned.eq_id IS NOT NULL ";
		this.listOptionRestrictions[3] = " docs_assigned.ls_id IS NOT NULL "; 
		
//		for (var i=1; i<this.listOptionRestrictions.length; i++) {
//			this.listOptionRestrictions[0] += " OR " + this.listOptionRestrictions[i];
//		}
	...
	*/
	abCompDocGrid_onDoc : function(){
		...
		View.openPaginatedReportDialog("ab-ep-document-paginate-rpt.axvw" ,null, parameters);
	},
	...
	*/
	initialListBoxOnPanelTitle: function(){
		...
		options.dom.options[0] = new Option("", this.listOptions[0]);
