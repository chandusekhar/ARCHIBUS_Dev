...
var abCompDocLibSelectController = View.createController('abCompDocLibSelectController',{
	...
	//list box options 
	listOptions: new Array("","training","ppe_type","medical","incident","restriction"),
	...
	*/
	initialListOptionRestrictions: function(){ 		
		...
		this.listOptionRestrictions[1] = " docs_assigned.training_id IS NOT NULL  ";
		this.listOptionRestrictions[2] = " docs_assigned.ppe_type_id IS NOT NULL ";
		this.listOptionRestrictions[3] = " docs_assigned.medical_monitoring_id IS NOT NULL ";
		this.listOptionRestrictions[4] = " docs_assigned.incident_id IS NOT NULL ";
		this.listOptionRestrictions[5] = " docs_assigned.restriction_id IS NOT NULL ";
...
//		}
	...
	*/
	abCompDocGrid_onDoc : function(){
		...
		View.openPaginatedReportDialog("ab-ehs-document-paginate-rpt.axvw" ,null, parameters);
	},
