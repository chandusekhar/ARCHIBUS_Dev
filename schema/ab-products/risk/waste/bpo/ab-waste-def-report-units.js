 ...
 * @author Lei
 */
View.createController('abWasteOutPutUnitsController', {
	
	abWasteDefUnitsUnitEditForm_afterRefresh:function(){
		//Set instruction for grid
		setInstruction(this.abWasteDefUnitsUnitEditForm);
...
function setInstruction(grid){
	 var instructions = "<span>"+getMessage("instruction1")+"<br/>"+getMessage("instruction2")+"</span>";
