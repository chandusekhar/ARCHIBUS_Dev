var abCbMyAssessItemsCtr = View.createController('abCbMyAssessItemsCtr', {
	...
	afterViewLoad: function(){
		...
		for (var i = 0; i < this.abCbAssessItemsTabs.tabs.length; i++) {
			...
			this.abCbAssessItemsTabs.tabs[i].mainControllerId = "abCbMyAssessItemsCtr";
		}
		...
		for (var i = 0; i < this.abCbAssessEditTabs.tabs.length; i++) {
			...
			this.abCbAssessEditTabs.tabs[i].mainControllerId = "abCbMyAssessItemsCtr";
		}
		for (var i = 0; i < this.abCbAssessActivityTabs.tabs.length; i++) {
			this.abCbAssessActivityTabs.tabs[i].taskMode = this.taskMode;
			this.abCbAssessActivityTabs.tabs[i].mainControllerId = "abCbMyAssessItemsCtr";
		}
	},
