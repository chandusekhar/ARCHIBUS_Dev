...
View.createController('abCbRptMyLoc', {
	...
	abCbRptMyLocBlDetail_onDoc:function(){
		var bl_id = this.abCbRptMyLocBlDetail.getFieldValue('bl.bl_id');
		var restriction = {"abCbRptLocBlDetail_ds":" bl.bl_id  = '" + bl_id + "'"};

		var consolePrintableRestriction = View.controllers.get('abCbRptMyLoc').printableRestriction;
	...
	abCbRptMyLocFlDetail_onDoc:function(){
		var bl_id = this.abCbRptMyLocFlDetail.getFieldValue('fl.bl_id');
		var fl_id = this.abCbRptMyLocFlDetail.getFieldValue('fl.fl_id');
	...
	abCbRptMyLocRmDetail_onDoc:function(){
		var bl_id = this.abCbRptMyLocRmDetail.getFieldValue('rm.bl_id');
		var fl_id = this.abCbRptMyLocRmDetail.getFieldValue('rm.fl_id');
		var rm_id = this.abCbRptMyLocRmDetail.getFieldValue('rm.rm_id');
...
function afterGeneratingTreeNode(treeNode){
    if (treeNode.tree.id != 'abCbRptMyLocSiteTree') {
        return;
    }
    var labelText1 = "";
