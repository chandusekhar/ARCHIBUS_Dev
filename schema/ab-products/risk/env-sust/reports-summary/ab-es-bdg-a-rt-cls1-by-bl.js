...
var esSumCls1ByBldgController = View.createController('esSumCls1ByBldgCtrl', {
	// selected projects
	selectedProjectIds: [],
	//console restriction
	consoleRestriction: '',
	...
	esFilterPanel_onShow: function(){
		...
		this.listEsSumCls1ByBldgBldgs.refresh(this.consoleRestriction + this.csi_parameter_bldg);
		this.repEsSumCls1ByBldg.show(false);
		this.repEsSumCls1ByBldgDetails.addParameter("consoleRestriction", this.consoleRestriction + this.csi_parameter_bldg);
	},
	/** 
	...
	esFilterPanel_onPaginatedReport: function(){
		...
		View.openPaginatedReportDialog("ab-es-bdg-a-rt-cls1-by-bl-prnt.axvw",
		{
...
function showSummary(row){
	esSumCls1ByBldgController.bl_id = row['activity_log.bl_id'];
	var restriction  = esSumCls1ByBldgController.consoleRestriction;
	restriction += " AND activity_log.bl_id = '"+ row['activity_log.bl_id'] +"'";
	esSumCls1ByBldgController.repEsSumCls1ByBldg.addParameter('consoleRestriction', restriction);
	esSumCls1ByBldgController.repEsSumCls1ByBldg.addParameter('classification_id', esSumCls1ByBldgController.csi_parameter_summary);
	esSumCls1ByBldgController.repEsSumCls1ByBldgDetails.addParameter('blId', " AND activity_log.bl_id = '"+ row['activity_log.bl_id'] +"'");
	esSumCls1ByBldgController.repEsSumCls1ByBldg.refresh();
}
...
function setRestrictionToXLS(){
	var controller = esSumCls1ByBldgController;
	...
	controller.repEsSumCls1ByBldgDetails.restriction = restriction;
}
