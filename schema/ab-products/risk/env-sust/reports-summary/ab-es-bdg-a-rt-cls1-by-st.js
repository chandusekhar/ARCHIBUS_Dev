...
var esSumCls1BySiteController = View.createController('esSumCls1BySiteCtrl', {
	// selected projects
	selectedProjectIds: [],
	//console restriction
	consoleRestriction: '',
	...
	esFilterPanel_onShow: function(){
		...
		this.listEsSumCls1BySiteSites.refresh(this.consoleRestriction + this.csi_parameter_site);
		this.repEsSumCls1BySite.show(false);
		this.repEsSumCls1BySiteDetails.addParameter("consoleRestriction", this.consoleRestriction + this.csi_parameter_site);
	},
	/** 
	...
	esFilterPanel_onPaginatedReport: function(){
		...
		View.openPaginatedReportDialog("ab-es-bdg-a-rt-cls1-by-st-prnt.axvw",
		{
...
function showSummary(row){
	esSumCls1BySiteController.site_id = row['activity_log.site_id'];
	var restriction  = esSumCls1BySiteController.consoleRestriction;
	restriction += " AND activity_log.site_id = '"+ row['activity_log.site_id'] +"'";
	esSumCls1BySiteController.repEsSumCls1BySiteDetails.addParameter("siteId", " AND activity_log.site_id = '"+ row['activity_log.site_id'] +"'");
	esSumCls1BySiteController.repEsSumCls1BySite.addParameter('consoleRestriction', restriction);
	esSumCls1BySiteController.repEsSumCls1BySite.addParameter('classification_id', esSumCls1BySiteController.csi_parameter_summary);
	esSumCls1BySiteController.repEsSumCls1BySite.refresh();
}
...
function setRestrictionToXLS(){
	var controller = esSumCls1BySiteController;
	...
	controller.repEsSumCls1BySiteDetails.restriction = restriction;
}
