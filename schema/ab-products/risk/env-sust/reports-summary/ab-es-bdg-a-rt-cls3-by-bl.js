...
var esSumCls3ByBldgController = View.createController('esSumCls3ByBldgCtrl', {
	// selected projects
	selectedProjectIds: [],
	//console restriction
	consoleRestriction: '',
	...
	esFilterPanel_onShow: function(){
		...
		this.listEsSumCls3ByBldgBldgs.refresh(this.consoleRestriction + this.csi_parameter_bldg);
		this.repEsSumCls3ByBldg.show(false);
		this.repEsSumCls3ByBldgDetails.addParameter("consoleRestriction", this.consoleRestriction + this.csi_parameter_bldg);
	},
	/** 
	...
	esFilterPanel_onPaginatedReport: function(){
		...
		View.openPaginatedReportDialog("ab-es-bdg-a-rt-cls3-by-bl-prnt.axvw",
		{
...
function showSummary(row){
	esSumCls3ByBldgController.bl_id = row['activity_log.bl_id'];
	var restriction  = esSumCls3ByBldgController.consoleRestriction;
	restriction += " AND activity_log.bl_id = '"+ row['activity_log.bl_id'] +"'";
	esSumCls3ByBldgController.repEsSumCls3ByBldgDetails.addParameter("blId", " AND activity_log.bl_id = '"+ row['activity_log.bl_id'] +"'");
	esSumCls3ByBldgController.repEsSumCls3ByBldg.addParameter('consoleRestriction', restriction);
	esSumCls3ByBldgController.repEsSumCls3ByBldg.addParameter('classification_id', esSumCls3ByBldgController.csi_parameter_summary);
	esSumCls3ByBldgController.repEsSumCls3ByBldg.refresh();
}
/**
 * set restriction on details panel for XSL export
 */
function setRestrictionToXLS(){
	var controller = esSumCls3ByBldgController;
	...
	controller.repEsSumCls3ByBldgDetails.restriction = restriction;
}
