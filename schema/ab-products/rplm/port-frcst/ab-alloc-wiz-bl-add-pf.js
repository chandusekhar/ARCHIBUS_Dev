var allocWizBlAddController = View.createController('allocWizBlAdd', {
	...
	createGroupsForBls: function(date_start, groupBy, pct_growth) {
		...
		try {
			var result =  Workflow.callMethod('AbRPLMGroupSpaceAllocation-PortfolioForecastingService-addRmEmLsGroups_pf', this.scn_id, blDataSet, date_start, groupBy, pct_growth, this.unitTitle);
			View.closeProgressBar();
