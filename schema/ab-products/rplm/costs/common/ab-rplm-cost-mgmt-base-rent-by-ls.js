var controller = View.createController('calculateCashCost', {
    ...
    afterViewLoad: function() {
        ...
        $('cost_cat_id_storage_sh').value = 'RENT - BASE RENT';
	...
	getConsoleRestriction: function() { 
		...
		//restriction += "AND cost_tran_recur.cost_cat_id IN (SELECT DISTINCT cost_cat.cost_cat_id FROM cost_cat, cost_tran_recur WHERE cost_tran_recur.cost_cat_id=cost_cat.cost_cat_id AND UPPER(cost_cat.cost_type) = 'BASE RENT') ";
