var vatBalDetailsCtrl = View.createController('vatBalCtrlDetails', {
	projectionType:null,
	IDs:'',
	isRecurring:null,
	isSchedule:null,
	...
	setVatBalParameters:function(result, projectionType, isRecurring, isSchedule, isActual, event, restriction, calculationPeriod, isMcAndVatEnabled, displayVAT, displayCurrency){
	...
	showData:function(){
		View.controllers.get('vatBalCtrlDetails').costTranRecurDetailsPanel.show(false);
		View.controllers.get('vatBalCtrlDetails').costTranSchedDetailsPanel.show(false);
		View.controllers.get('vatBalCtrlDetails').costTranActualDetailsPanel.show(false);
		View.controllers.get('vatBalCtrlDetails').lsDetailsPanel.show(false);
		View.controllers.get('vatBalCtrlDetails').blDetailsPanel.show(false);
		View.controllers.get('vatBalCtrlDetails').prDetailsPanel.show(false);
		View.controllers.get('vatBalCtrlDetails').acDetailsPanel.show(false);
		
		if (this.ID != ''){
		
		switch(this.projectionType){
			case 'ls':	
						View.controllers.get('vatBalCtrlDetails').lsDetailsPanel.refresh('ls_id = '+"'"+this.ID+"'");
						break;
			case 'ls_bl':	
						View.controllers.get('vatBalCtrlDetails').lsDetailsPanel.refresh('ls_id = '+"'"+this.ID+"'");
						break;
			case 'ls_pr':	
						...
						break;
			case 'bl':
						View.controllers.get('vatBalCtrlDetails').blDetailsPanel.refresh('bl_id = '+"'"+this.ID+"'");
						break;
			case 'property':
						View.controllers.get('vatBalCtrlDetails').prDetailsPanel.refresh('pr_id = '+"'"+this.ID+"'");
						break;
			case 'ac':
						View.controllers.get('vatBalCtrlDetails').acDetailsPanel.refresh('ac_id = '+"'"+this.ID+"'");
						break;
		}
		}
		...
		if (this.isRecurring){
			...
			this.costTranRecurDetailsPanel.refresh(this.restriction_recur);
			setPanelDisplay(this.costTranRecurDetailsPanel, "cost_tran_recur", this.isMcAndVatEnabled, this.displayCurrency);	
		}
		if (this.isSchedule){
			setPanelParameters(this.costTranSchedDetailsPanel, "cost_tran_sched", this.isMcAndVatEnabled, this.displayCurrency);
			this.costTranSchedDetailsPanel.refresh(this.restriction_sched);
			setPanelDisplay(this.costTranSchedDetailsPanel, "cost_tran_sched", this.isMcAndVatEnabled, this.displayCurrency);
		}
		if (this.isActual){
			setPanelParameters(this.costTranActualDetailsPanel, "cost_tran", this.isMcAndVatEnabled, this.displayCurrency);
			this.costTranActualDetailsPanel.refresh(this.restriction_actual);
			setPanelDisplay(this.costTranActualDetailsPanel, "cost_tran", this.isMcAndVatEnabled, this.displayCurrency);
		}
	}
});
