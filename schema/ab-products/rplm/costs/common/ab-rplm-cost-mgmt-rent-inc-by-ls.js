var controller = View.createController('calculateCashCost', {
    ...
    afterViewLoad: function() {
        ...
        var default_cost_cat_id = View.dataSources.get("dsGet_inc_cost_cat_id").getRecords();
        var incomeController = View.controllers.get('calculateCashCost');
        ...
        for(var i = 0; i < default_cost_cat_id.length; i++){
			incomeController.updateCostCatStorage(default_cost_cat_id[i].values['cost_cat.cost_cat_id'], 'cost_cat_id_storage_sh');
        }
