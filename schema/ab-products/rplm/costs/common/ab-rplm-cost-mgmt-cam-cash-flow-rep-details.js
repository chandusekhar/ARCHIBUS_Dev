var cashFlowDetailsCtrl = View.createController('cashFlowCtrlDetails', {
	...
	setCashFlowParameters:function(result, projectionType, isRecurring, isSchedule, isActual, event, restriction, calculationPeriod, isMcAndVatEnabled, displayVAT, displayCurrency){
	...
	costTranSchedDetailsPanel_beforeExportReport: function(panel, fieldDefs){
		return hideFieldBeforeExport(fieldDefs, "cost_tran_sched", this.isMcAndVatEnabled, this.displayCurrency.type);
	},
	costTranActualDetailsPanel_beforeExportReport: function(panel, fieldDefs){
		return hideFieldBeforeExport(fieldDefs, "cost_tran", this.isMcAndVatEnabled, this.displayCurrency.type);
	}
});
