...
function editLease(ls_id){
    ...
    openerController.abRepmLsTemplContact_list.refresh(View.controllers.get('abRepmLsTemplContactsController').getRestriction(ls_id));
...
function saveNewLease(){
    ...
    if (controller.useTemplate) {
        try {
            ...
            editLease(newLsId);
            controller.abRplmLsAdminLeaseTemplateSelectTab_grid.refresh();
            abRplmLsAdminLeaseTemplateSelectTab_ctrl.selectedLease = newLsId;
        } 
        catch (e) {
