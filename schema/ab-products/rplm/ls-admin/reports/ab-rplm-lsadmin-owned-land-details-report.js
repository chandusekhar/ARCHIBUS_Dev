var repLandDetailsMainController = View.createController('repLandDetailsMainController', {
	searchPattern:'',
...
function showDetails(event){
	...
	var targetCrtl = View.panels.get('reportPanel').contentView.controllers.get('repOwnLand');
	targetCrtl.ls_id = '';
	targetCrtl.bl_id = '';
