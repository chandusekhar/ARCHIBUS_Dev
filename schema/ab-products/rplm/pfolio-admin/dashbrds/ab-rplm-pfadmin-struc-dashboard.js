...
View.dashboardConfigObj.addAll(
		{id: 'panel_row1col1_abRepmStructBookMarketValController', groupBy: 'state'},
		{id: 'panel_row2col1_abRepmStructBookMarketValController', groupBy: 'city'},
		{id: 'panel_row3col1_abRepmStructMonthlyCapTransController', groupBy: 'city'}
	);
