var abRplmPfadminGpdCostByTypeCtrl = View.createController('abRplmPfadminGpdCostByTypeCtrl', {
	...
	afterInitialDataFetch: function(){
		...
		if(this.view.parameters){
			if(this.view.parameters.maximize){
				this.abRplmPfadminGpdCostByType_chart.setInstructions(instructionLabel);
			}
		}
		
		var restriction = this.getSqlRestriction(this.objFilter);
		this.abRplmPfadminGpdCostByType_chart.addParameter("filterRestriction", restriction);
		this.abRplmPfadminGpdCostByTypeDetails.addParameter("filterRestriction", restriction);
		this.abRplmPfadminGpdCostByType_chart.refresh();
