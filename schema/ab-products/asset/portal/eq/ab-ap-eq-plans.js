...
var abApEqPlansController = View.createController('abApEqPlansCtrl',{
	...
	panel_abApEqPlans_console_onPaginatedReport: function(){
		...
		View.openPaginatedReportDialog('ab-ap-eq-plans-pgrp.axvw', null, parameters);
	}
});
 ...
 */
function abApEqPlans_showEquipments(node){
...
function onClickHandler(pk, selected){
	if (selected) {
		...
		View.openDialog('ab-ap-eq-plans-detail.axvw', r, false, {
                width: 700,
                height: 1000
        });
