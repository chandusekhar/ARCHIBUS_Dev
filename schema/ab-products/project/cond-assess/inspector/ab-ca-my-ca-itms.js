...
//        titleObj.on('click', this.showPDAMenu, this, null);
    ...
    afterInitialDataFetch: function(){
		...
		}else if(this.view.taskInfo.activityId == 'AbAssetEAM'){
			//KB3048835
			this.view.setTitle(getMessage("title_eam_my_items"));
			var restriction = new Ab.view.Restriction();
			restriction.addClause('project.project_type', ['COMMISSIONING', 'ASSESSMENT', 'ASSESSMENT - ENVIRONMENTAL'], 'IN');
			restriction.addClause('activity_log.assessed_by', View.user.name, '=');
			this.listProjectsManMyCondAssess.refresh(restriction);
		}
    ...
    manMyCondAssessItems_onEdit: function(row){
        ...
        View.openDialog('ab-ca-add-edit-my-itm.axvw', restriction, false, {
            //width: 1000, 
            //height: 600,
    ...
    manMyCondAssessItems_onAddNew: function(){
        ...
        if (this.selectedProjectId != null) {
            ...
            var controller = this;
            View.openDialog('ab-ca-add-edit-my-itm.axvw', null, true, {
