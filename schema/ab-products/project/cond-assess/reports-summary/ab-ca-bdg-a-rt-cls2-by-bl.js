...
var caSumCls2ByBldgController = View.createController('caSumCls2ByBldgCtrl', {
	// selected projects
	selectedProjectIds: [],
	//console restriction
	consoleRestriction: '',
	...
	caFilterPanel_onShow: function(){
		...
		this.listCASumCls2ByBldgBldgs.refresh(this.consoleRestriction + this.csi_parameter_bldg);
		this.repCASumCls2ByBldg.show(false);
		this.repCASumCls2ByBldgDetails.addParameter("consoleRestriction", this.consoleRestriction + this.csi_parameter_bldg);
	},
	/** 
	...
	caFilterPanel_onPaginatedReport: function(){
		...
		View.openPaginatedReportDialog("ab-ca-bdg-a-rt-cls2-by-bl-prnt.axvw",
		{
...
function showSummary(row){
	caSumCls2ByBldgController.bl_id = row['activity_log.bl_id'];
	var restriction  = caSumCls2ByBldgController.consoleRestriction;
	restriction += " AND activity_log.bl_id = '"+ row['activity_log.bl_id'] +"'";
	caSumCls2ByBldgController.repCASumCls2ByBldgDetails.addParameter("blId", " AND activity_log.bl_id = '"+ row['activity_log.bl_id'] +"'");
	caSumCls2ByBldgController.repCASumCls2ByBldg.addParameter('consoleRestriction', restriction);
	caSumCls2ByBldgController.repCASumCls2ByBldg.addParameter('classification_id', caSumCls2ByBldgController.csi_parameter_summary);
	caSumCls2ByBldgController.repCASumCls2ByBldg.refresh();
}
...
function setRestrictionToXLS(){
	var controller = caSumCls2ByBldgController;
	...
	controller.repCASumCls2ByBldgDetails.restriction = restriction;
}
