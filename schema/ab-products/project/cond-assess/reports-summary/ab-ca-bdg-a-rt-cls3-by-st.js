...
var caSumCls3BySiteController = View.createController('caSumCls3BySiteCtrl', {
	// selected projects
	selectedProjectIds: [],
	//console restriction
	consoleRestriction: '',
	...
	caFilterPanel_onShow: function(){
		...
		this.listCASumCls3BySiteSites.refresh(this.consoleRestriction + this.csi_parameter_site);
		this.repCASumCls3BySite.show(false);
		this.repCASumCls3BySiteDetails.addParameter("consoleRestriction", this.consoleRestriction + this.csi_parameter_site);
	},
	/** 
	...
	caFilterPanel_onPaginatedReport: function(){
		...
		View.openPaginatedReportDialog("ab-ca-bdg-a-rt-cls3-by-st-prnt.axvw",
		{
...
function showSummary(row){
	caSumCls3BySiteController.site_id = row['activity_log.site_id'];
	var restriction  = caSumCls3BySiteController.consoleRestriction;
	restriction += " AND activity_log.site_id = '"+ row['activity_log.site_id'] +"'";
	caSumCls3BySiteController.repCASumCls3BySiteDetails.addParameter("siteId", " AND activity_log.site_id = '"+ row['activity_log.site_id'] +"'");
	caSumCls3BySiteController.repCASumCls3BySite.addParameter('consoleRestriction', restriction);
	caSumCls3BySiteController.repCASumCls3BySite.addParameter('classification_id', caSumCls3BySiteController.csi_parameter_summary);
	caSumCls3BySiteController.repCASumCls3BySite.refresh();
}
...
function setRestrictionToXLS(){
	var controller = caSumCls3BySiteController;
	...
	controller.repCASumCls3BySiteDetails.restriction = restriction;
}
