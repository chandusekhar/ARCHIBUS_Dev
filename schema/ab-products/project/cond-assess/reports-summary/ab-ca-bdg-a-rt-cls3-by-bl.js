...
var caSumCls3ByBldgController = View.createController('caSumCls3ByBldgCtrl', {
	// selected projects
	selectedProjectIds: [],
	//console restriction
	consoleRestriction: '',
	...
	caFilterPanel_onShow: function(){
		...
		this.listCASumCls3ByBldgBldgs.refresh(this.consoleRestriction + this.csi_parameter_bldg);
		this.repCASumCls3ByBldg.show(false);
		this.repCASumCls3ByBldgDetails.addParameter("consoleRestriction", this.consoleRestriction + this.csi_parameter_bldg);
	},
	/** 
	...
	caFilterPanel_onPaginatedReport: function(){
		...
		View.openPaginatedReportDialog("ab-ca-bdg-a-rt-cls3-by-bl-prnt.axvw",
		{
...
function showSummary(row){
	caSumCls3ByBldgController.bl_id = row['activity_log.bl_id'];
	var restriction  = caSumCls3ByBldgController.consoleRestriction;
	restriction += " AND activity_log.bl_id = '"+ row['activity_log.bl_id'] +"'";
	caSumCls3ByBldgController.repCASumCls3ByBldgDetails.addParameter("blId", " AND activity_log.bl_id = '"+ row['activity_log.bl_id'] +"'");
	caSumCls3ByBldgController.repCASumCls3ByBldg.addParameter('consoleRestriction', restriction);
	caSumCls3ByBldgController.repCASumCls3ByBldg.addParameter('classification_id', caSumCls3ByBldgController.csi_parameter_summary);
	caSumCls3ByBldgController.repCASumCls3ByBldg.refresh();
}
/**
 * set restriction on details panel for XSL export
 */
function setRestrictionToXLS(){
	var controller = caSumCls3ByBldgController;
	...
	controller.repCASumCls3ByBldgDetails.restriction = restriction;
}
