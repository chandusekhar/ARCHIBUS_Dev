var projCreateWorkPkgsController = View.createController('projCreateWorkPkgs', {
	...
	afterInitialDataFetch : function() {
		clearConsole();
		View.panels.get('consolePanel').enableField('project.project_type', false);
		View.panels.get('consolePanel').setFieldValue('project.project_type', 'COMMISSIONING');
	},
...
function onProjectIdSelval() {
	projectIdSelval("project.project_type LIKE 'COMMISSIONING%'");
}
