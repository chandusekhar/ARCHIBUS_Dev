...
function projMngRptSchedVarPkgCrossTable_onclick(obj) {
	var grid = View.panels.get('projMngRptSchedVarPkgGrid');
	if (obj.restriction.clauses.length > 1) {
		...
		var restriction = View.panels.get('projMngRptSchedVarPkgCrossTable').restriction;
