var projFcpmWipBarController = View.createController('projFcpmWipBar',{	
		
	projFcpmWipBarChart_afterRefresh: function() {
		...
		this.projFcpmWipBarChart.appendTitle(title);		
   	}
});

function openBarChartDetails(obj) {
	var openerController = View.controllers.get('projFcpmWip');
	var parameters = {};
