var updateSelectController = View.createController('updateSelectController', {
	...
	afterViewLoad : function() {
		...
		this.wr_upd_sel_wr_report.addParameter('emWorkflowSubstitutes', Workflow.callMethod('AbBldgOpsHelpDesk-RequestsService-getWorkflowSubstitutes','em_id').message);
	},

    afterInitialDataFetch: function(){
	if(valueExists(View.parentTab)){
    ...
    wr_upd_sel_wr_report_afterRefresh: function(){
    	highlightWrBySubstitute(this.wr_upd_sel_wr_report,true);
	}    
});
...
function setRestriction(){
    var console =  View.panels.get('wr_upd_sel_wr_console');
    ...
    var panel =  View.panels.get('wr_upd_sel_wr_report'); 
...
function closeWRs(){
    var grid =  View.panels.get('wr_upd_sel_wr_report');
