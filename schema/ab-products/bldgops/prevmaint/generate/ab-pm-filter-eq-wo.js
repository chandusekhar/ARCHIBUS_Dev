...
function openDialog(panelid,type){
    ...
    if (type == "bl") {
        View.selectValue(panelid, getMessage('blCode'), ['eq.bl_id','eq.site_id'], 'bl', ['bl.bl_id','bl.site_id'], ['bl.site_id','bl.bl_id'], null, null, null, null, null, 800, 500, null, null, null);
    }
    else 
        if (type == "fl") {
            View.selectValue(panelid, getMessage('flCode'), ['eq.fl_id','eq.bl_id'], 'fl', ['fl.fl_id','fl.bl_id'], ['fl.bl_id','fl.fl_id'], null, null, null, null, null, 800, 500, null, null, null);
        }
        else 
            if (type == "site") {
