var abHpdRVOndemandSelectArchivedController =  View.createController("abHpdRVOndemandSelectArchivedController",{
...
function SaveConsoleParameters(){
	abHpdRVOndemandSelectArchivedController.saveRequestConsoleParameters();
}
