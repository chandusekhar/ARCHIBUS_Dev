...
var controller = View.createController('abOpsConsoleRedlinesController', {
    ...
    abHelpdeskRedlinesDialog_DrawingPanel_onSave:function(){
    	...
    	if(this.abHelpdeskRedlinesDialog_DrawingPanel.saveRedmarksForServiceRequest(c.activityLogId)){
    		Workflow.callMethod('AbBldgOpsOnDemandWork-WorkRequestService-copyDocumentsFromServiceRequestToWr', parseInt(c.activityLogId), parseInt(c.workRequestId));
    		c.refreshDocsPanel();
    	}
    }
