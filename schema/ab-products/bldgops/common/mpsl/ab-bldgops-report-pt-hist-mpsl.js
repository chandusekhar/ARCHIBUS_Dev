...
var abBldgopsReportPtHistController = View.createController('abBldgopsReportPtHistController', {
    ...
    normalConsoleField: new Array(['wr.site_id','','hwr.site_id'], ['wr.bl_id','','hwr.bl_id'], ['wr.fl_id','','hwr.fl_id'], ['wr.dv_id','','hwr.dv_id'], ['wr.dp_id','','hwr.dp_id'],['wr.prob_type','like','hwr.prob_type'],['wrpt.pt_store_loc_id','','hwrpt.pt_store_loc_id']),
    ...
    checkFilterValidation: function(){
    	if (compareLocalizedDates(this.abBldgopsReportPtHistConsole.getFieldElement('wrpt.date_assigned.to').value, this.abBldgopsReportPtHistConsole.getFieldElement('wrpt.date_assigned.from').value)) {
