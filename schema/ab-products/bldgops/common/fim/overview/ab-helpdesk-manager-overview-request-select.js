var abHpdMgrOverviewReqSlktController = View.createController("abHpdMgrOverviewReqSlktController",{
	...
	requestConsole_afterRefresh: function(){
		...
		var ifRefresh = ABHDC_getTabsSharedParameters()["refresh_from_ab_helpdesk_mgr_overview_request_select"]; 
		if( valueExists(ifRefresh)&& ifRefresh == true){
			ABHDC_getTabsSharedParameters()["refresh_from_ab_helpdesk_mgr_overview_request_select"] = false;
