...
var abondemandrptacController = View.createController("abondemandrptacController", {
...
function onClickItem(obj){
	onArchievedWrCrossTableClick(obj,View.controllers.get("abondemandrptacController").restriction);
}
