var abondemandrptblController = View.createController("abondemandrptblController", {
    parentType: 'bl',
    restriction: '',
...
function onClickItem(obj){
	onArchievedWrCrossTableClick(obj,View.controllers.get("abondemandrptblController").restriction);
}
