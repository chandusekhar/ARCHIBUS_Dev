var abondemandrpteqstdController = View.createController("abondemandrpteqstdController", {
    ...
    afterInitialDataFetch: function(){
        ...
        this.fieldsArraysForRestriction = new Array(['hwr.site_id'], ['hwr.bl_id'], ['hwr.dv_id'], ['hwr.dp_id']);
...
function onClickItem(obj){
	onArchievedWrCrossTableClick(obj,View.controllers.get("abondemandrpteqstdController").restriction);
}
