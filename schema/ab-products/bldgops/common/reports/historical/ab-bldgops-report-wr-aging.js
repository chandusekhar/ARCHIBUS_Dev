...
var abBldgopsReportWrAgingGridController = View.createController('abBldgopsReportWrAgingGridController', {
    ...
    abBldgopsReportWrAgingConsole_onClear: function() {
    	this.abBldgopsReportWrAgingConsole.clear();
    	$("excludeChangedRequests").checked = false;
    },
    ...
    getConsoleRestriction: function(){
        ...
        var excludeChangedRequests = $("excludeChangedRequests");        
        if (excludeChangedRequests.checked) {
        	this.consoleResWr += " AND wr.request_params_updated = 0 "; 
        }
