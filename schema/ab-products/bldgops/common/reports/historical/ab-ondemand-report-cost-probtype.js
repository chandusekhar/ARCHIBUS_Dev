...
function showLine(){
	View.controllers.get('abOnDemandRptCostProbtypeController').otherRes = View.controllers.get('abOnDemandRptCostProbtypeController').restriction.replace(/wr./g, "wrhwr."); 
...
function onProbtypeCostCrossTableClick(obj) {
	...
	onCostCrossTableClick( obj, View.controllers.get('abOnDemandRptCostProbtypeController').restriction.replace(/wr./g, "wrhwr."));
}
