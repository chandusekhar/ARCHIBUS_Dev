...
function calendarCreateNewItem_JS(fromDate,fromTime,toDate,toTime){
	var restriction = {
			'activity_log.date_scheduled' : fromDate,
			'activity_log.date_scheduled_end' : toDate
	}
...
function calendarUpdateItem_JS(id,fromDate,fromTime,toDate,toTime){
	...
	var record = dataSource.getRecord("activity_log.activity_log_id = " + id);
	record.setValue("activity_log.date_scheduled",fromDate);
	record.setValue("activity_log.date_scheduled_end",toDate);
