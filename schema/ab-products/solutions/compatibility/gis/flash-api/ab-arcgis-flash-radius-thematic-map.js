...
View.createController('showMap', {
	...
	afterViewLoad: function(){
		// initialize the Flash Radius Map control
	...
	pr_list_onShowProperties: function() {  
		...
		// create the marker property to specify property markers for the map, including the radius field
		var markerProperty = new Ab.flash.ArcGISRadiusMarkerProperty(
			'pr_ds', 
			['property.lat', 'property.lon'], 
			['property.pr_id'],
			['property.area_manual', 'property.value_market', 'property.value_book', 'property.radius'],
			'property.radius');
