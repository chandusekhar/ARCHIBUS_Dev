View.createController('showMapUsingBuckets', {
	...
	bl_list_onShowBuildings: function() {  
		...
		var sizeBuckets = [];
		sizeBuckets.push({limit:14,symbolSize:10});
		sizeBuckets.push({limit:24,symbolSize:20});
		sizeBuckets.push({limit:30,symbolSize:30});
		sizeBuckets.push({limit:30,symbolSize:40});		
