...
<!-- ab-ex-cfm-personnel-mgmt.xsl for ab-ex-cfm-personnel-mgmt.axvw -->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">	
	...
	<xsl:template match="/">
		...
		<head>	
			...
			<script language="JavaScript" src="#Attribute%//@relativeFileDirectory%/ab-ex-cfm-personnel-mgmt.js"><xsl:value-of select="$whiteSpace"/></script>
		</head>
