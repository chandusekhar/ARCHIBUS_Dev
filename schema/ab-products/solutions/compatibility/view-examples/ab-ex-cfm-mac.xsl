...
<!-- ab-ex-cfm-mac.xsl for ab-ex-cfm-mac.axvw -->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">	
	...
	<xsl:template match="/">
		...
		<head>	
			...
			<script language="JavaScript" src="#Attribute%//@relativeFileDirectory%/ab-ex-cfm-mac.js"><xsl:value-of select="$whiteSpace"/></script>
		</head>
