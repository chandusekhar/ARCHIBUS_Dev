                    ...
                    function findMistranslatedParams(){
                        ...
                        try {
                               var result = Workflow.callMethod(
                                'AbSystemAdministration-LocalizationRead-findMistranslatedParams', Ext.get('language').dom.value, 'ab-localization-edit-lang-files.axvw', 'abLocalizationEditLangFiles_ds_0');
