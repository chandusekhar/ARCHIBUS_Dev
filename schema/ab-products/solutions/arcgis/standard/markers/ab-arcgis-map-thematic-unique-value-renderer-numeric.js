View.createController('mapController', {
	...
	bl_list_onShowBuildings: function() {  
		...
		var markerProperty = new Ab.arcgis.ArcGISMarkerProperty(
			...
			['bl.bl_id', 'bl.use1', 'bl.count_fl'] 	// infowindow fields
		);
		...
		// enable thematic markers
     	var thematicBuckets = []; // use unique value renderer
     	markerProperty.setThematic('bl.count_fl', thematicBuckets);	
		...
		if (selectedRows.length !== 0) {	
			...
			restriction.addClause('bl.count_fl', 'null', '=', "OR");
		}
