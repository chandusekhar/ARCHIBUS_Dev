...
public class ServletUtilsTest extends TestCase {
    ...
    public final void testExtractHeaderValues() {
        ...
        Map<String, String> values = ServletUtils.extractHeaderValues(request, keys);
     ...
     * .
     */
    public final void testExtractParameterValues() {
        List<String> keys = new ArrayList<String>();
        String key1 = "key1";
        keys.add(key1);
        String key2 = "key2";
        ...
        Map<String, String> values = ServletUtils.extractParameterValues(request, keys);
    ...
    public final void testExtractCookiesValues() {
        ...
        Map<String, String> values = ServletUtils.extractCookiesValues(request, keys);
