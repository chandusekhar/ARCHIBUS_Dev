...
/**
 * Integration test for preauth/projectid-source/header/ configuration.
 *
 * @author Valery Tydykov
 *
 */
public class PreauthProjectidHeaderIntegrationTest extends com.archibus.fixture.IntegrationTestBase {
    ...
    protected String[] getConfigLocations() {
        ...
        "/context/security/preauth/projectid-source/header/projectid-source.xml" };
    }

    public void testBuildDetailsFromHeader() {
        final MockHttpServletRequest request = new MockHttpServletRequest();
        request.addHeader("projectId", getProjectId());
