 ...
 * division, 1 with a secondary room division, distinct divisions.
 * 
 * @author Ana Paduraru
 * 
 */
public class TestTwoRmpctTwoDistinctDv extends AbstractSurveyTest {
    /** {@inheritDoc} */
    @Override
     ...
     */
    public void testAddTwoEmTransToRoomWithTwoDvDistinctRmpct() {
     ...
     */
    public void testChangePrimaryDvToRoomWithTwoDistinctDvRmpct() {
        ...
        addNewRmpctSyncRecord(BL_ID_VALUE, FL_ID_VALUE, RM_ID_VALUE, thirdDvId, thirdDpId, null, 1,
            null, SpaceConstants.ACTION_INSERT);
        ...
        verifyInsertedRecord(2, 1, thirdDvId, thirdDpId, null, 1, null);
    }
    
    /**
     * Delete the primary room division.
     */
    public void testDeletePrimaryDvToRoomWithTwoDistinctDvRmpct() {
        // set the rmpctmob_sync records
        addNewRmpctSyncRecord(BL_ID_VALUE, FL_ID_VALUE, RM_ID_VALUE, DV_ID_VALUE, DP_ID_VALUE,
            null, 1, null, ACTION_DELETE);
     ...
     */
    public void testDeleteBothDvToRoomWithTwoDistinctDvRmpct() {
        // set the rmpctmob_sync records
        addNewRmpctSyncRecord(BL_ID_VALUE, FL_ID_VALUE, RM_ID_VALUE, DV_ID_VALUE, DP_ID_VALUE,
            null, 1, null, ACTION_DELETE);
