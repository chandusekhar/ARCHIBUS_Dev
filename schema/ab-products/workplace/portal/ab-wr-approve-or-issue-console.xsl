...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/">
		...
		<head>	
			...
			<script language="JavaScript" src="#Attribute%//@relativeFileDirectory%/ab-wr-approve-or-issue-console.js"><xsl:value-of select="$whiteSpace"/></script>
					...
					<table width="550">
						<tr>
							...
							<td >
								...
								<input class="selectValue_AbActionButtonFormStdWidth" type="button" title="{$selectVAfmAction/tip}" value="{$selectVAfmAction/title}" onclick='onSelectV_wr_code("{$selectVAfmAction/@serialized}","wr.wr_id",""); selectValueInputFieldID="wr.wr_id";'/>
							</td>
