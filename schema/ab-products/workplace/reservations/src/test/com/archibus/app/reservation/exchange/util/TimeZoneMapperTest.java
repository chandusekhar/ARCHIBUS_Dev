...
public class TimeZoneMapperTest extends TestCase {
    ...
    /** Olson time zone ID for testing. */
    ...
    public void testGetOlsonId() {
        ...
        Assert.assertEquals(AMERICA_NEW_YORK, mapper.getOlsonId(EASTERN_STANDARD_TIME));
    ...
    public void testGetWindowsId() {
        ...
        Assert.assertEquals(EASTERN_STANDARD_TIME, mapper.getWindowsId(AMERICA_NEW_YORK));
