...
public class ReservationDataSourceTestBase extends ConfiguredDataSourceTestBase {
    ...
    /** The number of attendees in the room allocation. */
    protected static final int ATTENDEES_IN_ROOM = 5;
    ...
    public void onSetUp() throws Exception {
        ...
        this.existingReservation = createReservation(
            new TimePeriod(startDate, startDate, startTime, endTime), roomArrangement);
    }
    ...
    protected RoomReservation createReservation(final TimePeriod timePeriod,
        ...
        reservation.getRoomAllocations().get(0).setAttendeesInRoom(ATTENDEES_IN_ROOM);
    ...
    /**
     * Create a local time period that started before now and ends after now.
     *
     * @return the local time period
     */
    protected TimePeriod getCurrentLocalTimePeriod() {
        final TimePeriod timePeriod =
                new TimePeriod(LocalDateTimeUtil.currentLocalDate(null, null, null, BL_ID), null,
                    LocalDateTimeUtil.currentLocalTime(null, null, null, BL_ID), null);

        final Calendar calendar = Calendar.getInstance();
        calendar.setTime(timePeriod.getStartDateTime());
        calendar.add(Calendar.HOUR, -1);
        timePeriod.setStartDateTime(calendar.getTime());
        calendar.add(Calendar.HOUR, 2);
        timePeriod.setEndDateTime(calendar.getTime());
        return timePeriod;
    }
