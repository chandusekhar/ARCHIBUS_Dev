...
public class WeeklyPatternTest extends RecurrencePatternTestBase {
    ...
    /**
     * Test WeeklyPattern.toString() using special days.
     */
    public void testToStringSpecialDays() {
        final Calendar endDate = Calendar.getInstance();
        endDate.clear();
        endDate.set(YEAR, Calendar.DECEMBER, DAY_OF_MONTH);
        final List<DayOfTheWeek> dayOfTheWeek = new ArrayList<DayOfTheWeek>();
        dayOfTheWeek.add(DayOfTheWeek.Weekday);
        this.pattern =
                new WeeklyPattern(this.calendar.getTime(), endDate.getTime(), 1,
                    dayOfTheWeek);
        Assert.assertEquals(
            "<recurring type=\"week\" value1=\"1,1,1,1,1,0,0\" value2=\"1\" value3=\"\" value4=\"\" total=\"\" />",
            this.pattern.toString());
        
        dayOfTheWeek.clear();
        dayOfTheWeek.add(DayOfTheWeek.WeekendDay);
        
        Assert.assertEquals(
            "<recurring type=\"week\" value1=\"0,0,0,0,0,1,1\" value2=\"1\" value3=\"\" value4=\"\" total=\"\" />",
            this.pattern.toString());
        
        dayOfTheWeek.clear();
        dayOfTheWeek.add(DayOfTheWeek.Day);
        
        Assert.assertEquals(
            "<recurring type=\"week\" value1=\"1,1,1,1,1,1,1\" value2=\"1\" value3=\"\" value4=\"\" total=\"\" />",
            this.pattern.toString());
    }
}
