...
public class TimelineServiceTest extends RoomReservationServiceTestBase {
    ...
    public void testLoadRoomTimeline() {
        ...
        final JSONObject timeline =
                this.timelineService.loadRoomArrangementTimeLine(this.startDate, this.endDate,
                    this.startTime, this.endTime, filter, null, 0);
    ...
    public void testLoadAttendeeTimeline() {
        ...
        final JSONObject locationFilter = new JSONObject();
    ...
    public void testGetFirstAndLastDate() {
        ...
        DataRecord dates =
                this.recurrenceService.getFirstAndLastDate(startDate, null, recurringRule, null,
                    null);
    ...
    // TODO test for conference calls
