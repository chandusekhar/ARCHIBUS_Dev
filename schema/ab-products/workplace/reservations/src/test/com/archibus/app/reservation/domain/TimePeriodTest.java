...
public class TimePeriodTest extends TestCase {
    ...
    public void testEquals() {
        ...
        final TimePeriod timePeriod2 = new TimePeriod();
        timePeriod2.copyFrom(timePeriod1);
        Assert.assertTrue(timePeriod1.equals(timePeriod2));
        Assert.assertTrue(timePeriod2.equals(timePeriod1));

        timePeriod2.setStartDate(new java.sql.Date(timePeriod1.getStartDate().getTime()));
        Assert.assertTrue(timePeriod1.equals(timePeriod2));
        Assert.assertTrue(timePeriod2.equals(timePeriod1));

        timePeriod2.setStartTime(timePeriod2.getEndTime());
        Assert.assertFalse(timePeriod1.equals(timePeriod2));
        Assert.assertFalse(timePeriod2.equals(timePeriod1));
    }
