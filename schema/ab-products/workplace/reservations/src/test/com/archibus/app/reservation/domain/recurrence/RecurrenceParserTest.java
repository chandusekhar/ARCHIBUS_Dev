...
public class RecurrenceParserTest extends TestCase {
    ...
    public void testParseDailyRecurrence() {
        ...
        final Recurrence dailyRecurrence =
                RecurrenceParser.parseRecurrence(startDate, null, DAILY_PATTERN);
    ...
    public void testParseWeeklyRecurrence() {
        ...
        final Recurrence weeklyRecurrence =
                RecurrenceParser.parseRecurrence(startDate, null, WEEKLY_PATTERN);
    ...
    public void testParseMonthlyRecurrence() {
        ...
        final Recurrence monthlyRecurrence =
                RecurrenceParser.parseRecurrence(startDate, null, MONTHLY_PATTERN);
    ...
    public void testParseMonthlyRecurrence2() {
        ...
        final Recurrence monthlyRecurrence =
                RecurrenceParser.parseRecurrence(startDate, null, MONTHLY_PATTERN2);
    ...
    public void testParseYearlyRecurrence() {
        ...
        final Recurrence yearlyRecurrence =
                RecurrenceParser.parseRecurrence(startDate, null, YEARLY_PATTERN);
    ...
    public void testParseYearlyRecurrence2() {
        ...
        final Recurrence yearlyRecurrence =
                RecurrenceParser.parseRecurrence(startDate, null, YEARLY_PATTERN2);
