...
public class AttendeeTimelineServiceHelper {
    ...
    private void createAttendeeEvents(final RoomReservation reservation, final Date date,
        ...
        final Map<String, AttendeeAvailability> calendarEventsPerAttendee =
                this.availabilityService.findAttendeeAvailability(reservation, date, timeZone,
                    userEmail, emails);
        ...
        for (final String email : emails) {
            ...
            if (availability.isSuccessful()) {
                ...
                for (final ICalendarEvent calendarEvent : calendarEvents) {
                    if (!(StringUtil.notNullOrEmpty(uniqueId) && uniqueId.equals(calendarEvent
                        .getEventId()))) {
    ...
    private String getUniqueIdForAttendeeEvents(final RoomReservation reservation) {
        ...
        if (reservation != null) {
            ...
            } else if (reservation.getConferenceId() == null || reservation.getConferenceId() == 0) {
