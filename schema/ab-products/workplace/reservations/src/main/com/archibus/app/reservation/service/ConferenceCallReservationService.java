...
public class ConferenceCallReservationService extends RoomReservationWfrBase {
     ...
     */
    public final void canEditConferenceCall(final Integer conferenceId) throws ReservationException {
        ...
        if (DataSourceUtils.isVpaEnabled()) {
            ...
            this.roomAllocationDataSource.addRestriction(Restrictions
                .sql("${sql.getVpaRestrictionForTable('bl')}"));
        } else {
        ...
        for (final RoomReservation reservation : reservations) {
            ...
            if (this.roomAllocationDataSource.get(allocation.getId()) == null) {
                ...
                throw new ReservationException(
                    ...
                    ConferenceCallReservationService.class, reservation.getReserveId());
            }
     ...
     */
    public String getLocationString(final DataRecord reservation, final DataSetList roomAllocations) {
    ...
    public String getLocationStringForSingleEdit(final DataRecord reservation,
        ...
        final List<RoomReservation> othersInConfCall =
                this.reservationDataSource.getByConferenceId(roomReservation.getConferenceId(),
                    false);
        location.append(HTML_P_START);
        // @translatable
        location.append(EventHandlerBase.localizeString("Other locations in this conference call:",
            ConferenceCallReservationService.class.getName()));
        location.append(HTML_P_END);
        location.append(HTML_P_START);
        for (final RoomReservation otherReservation : othersInConfCall) {
            if (!otherReservation.getReserveId().equals(roomReservation.getReserveId())) {
                location.append(this.spaceService.getLocationString(otherReservation
    ...
    /**
     * Strip the conference call locations from the comments.
     *
    ...
    public String stripConferenceCallLocations(final String email, final String comments) {
        return this.messagesService.stripConferenceCallLocations(email, comments);
    }
    ...
    public Double calculateTotalCost(final DataRecord reservation,
        ...
        for (final DataRecord record : roomAllocations.getRecords()) {
            ...
            roomReservation.addRoomAllocation(this.roomAllocationDataSource
                .convertRecordToObject(record));
            totalCost +=
                    this.reservationDataSource.calculateCosts(roomReservation)
                            * numberOfOccurrences;
    ...
    public List<Integer> cancelRecurringConferenceReservation(final Integer firstConferenceId,
        ...
        if (firstConferenceId != null && firstConferenceId > 0) {
            ...
            final Integer[] conferenceIds =
                    this.reservationDataSource.getRecurringConferenceIds(conferenceParentId,
                        firstConferenceId);
    ...
    public DataSetList saveReservation(final DataRecord reservation,
        ...
        final boolean editRecurring =
                primaryReservation.getParentId() != null
                        && !primaryReservation.getStartDate().equals(
                            primaryReservation.getEndDate());
        ...
        if (editRecurring) {
            ...
            confCallReservations =
                    this.compileConferenceReservations(reservation, roomAllocations,
                        primaryReservation);
        ...
        primaryReservation.setTimePeriod(primaryReservation.getCreatedReservations().get(0)
            .getTimePeriod());
    ...
    private void editRecurringConferenceCallReservations(final TimePeriod primaryTimePeriod,
        ...
        for (final RoomReservation originalOccurrence : originalReservations) {
            ...
            originalOccurrence.setTimeZone(this.timeZoneCache
                .getBuildingTimeZone(originalOccurrence.determineBuildingId()));
            final TimePeriod timePeriodForOccurrence =
                    ReservationUtils.getTimePeriodInTimeZone(originalOccurrence,
                        primaryTimePeriod.getTimeZone());
            ...
            for (final RoomReservation existingOccurrence : existingReservationsForOccurrence) {
                ...
                if (matchingConfCallReservation == null) {
                    ...
                    this.cancelReservationService.cancelReservation(existingOccurrence);
                } else {
            ...
            for (final RoomReservation confCallReservation : confCallReservationsPendingForOccurrence) {
                if (confCallReservation.getReserveId() == null) {
                    ...
                    confCallOccurrence.setRecurringDateModified(originalOccurrence
                        .getRecurringDateModified());
    ...
    private void saveConferenceCallReservations(final RoomReservation primaryReservation,
        ...
        this.reservationService.saveCompiledConferenceCallReservations(confCallReservations, recurrence);
    }
    ...
    private List<RoomReservation> compileConferenceReservations(final DataRecord reservation,
        ...
        final List<RoomReservation> existingConfCallReservations =
                this.reservationDataSource.getByConferenceId(primaryReservation.getConferenceId(),
                    true);
        ...
        for (int i = 0; i < roomAllocations.getRecords().size(); ++i) {
            final RoomAllocation allocation =
                    this.roomAllocationDataSource.convertRecordToObject(roomAllocations
                        .getRecord(i));
    ...
    public DataSetList editSingleRoomReservation(final DataRecord reservation,
        ...
        for (final RoomReservation createdReservation : createdReservations) {
            ...
            if (primaryReservation == null) {
                primaryReservation = confCallReservations.get(0);
                primaryReservation.setCreatedReservations(new ArrayList<RoomReservation>(
