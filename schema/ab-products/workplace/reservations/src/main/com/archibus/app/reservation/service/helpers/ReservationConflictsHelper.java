...
public final class ReservationConflictsHelper {
     ...
     */
    public static void checkNumberOfConflictsCreated(final int numberOfConflicts, final int numberOk) {
        final RoomConflictsMode conflictsMode = ReservationConflictsHelper.getConflictsMode();
        if (numberOfConflicts > conflictsMode.getMaxConflictsAllowed(numberOk + numberOfConflicts)) {
            // @translatable
            throw new ReservationException(
                ...
                ReservationConflictsHelper.class, numberOfConflicts, numberOk + numberOfConflicts);
        }
    }
    ...
    public static RoomConflictsMode getConflictsMode() {
        return RoomConflictsMode
            .getRoomConflictsMode(com.archibus.service.Configuration
                .getActivityParameterInt(
