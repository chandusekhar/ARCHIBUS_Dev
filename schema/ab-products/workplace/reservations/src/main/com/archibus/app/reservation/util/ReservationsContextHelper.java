...
public final class ReservationsContextHelper {
    ...
    /**
     * Get the Web Central URL for external users.
     ...
     */
    public static String localizeMessage(final String referencedBy, final String messageId) {
        return EventHandlerBase.localizeMessage(ContextStore.get().getEventHandlerContext(),
            RESERVATIONS_ACTIVITY, referencedBy,
            messageId, null);
    }
