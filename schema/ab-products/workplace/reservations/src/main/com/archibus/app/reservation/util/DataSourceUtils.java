...
public final class DataSourceUtils {
    ...
    public static boolean isEmployeeEmail(final String email) {
        final DataSource employeeDataSource =
                DataSourceFactory.createDataSourceForFields(Constants.EM_TABLE_NAME, new String[] {
                        Constants.EM_ID_FIELD_NAME, Constants.EMAIL_FIELD_NAME, });
        employeeDataSource.setApplyVpaRestrictions(false);
        employeeDataSource.addRestriction(Restrictions.eq(Constants.EM_TABLE_NAME,
    ...
    public static long getDaysDifference(final ITimePeriodBased allocation,
        ...
        final long daysDifference =
                (allocation.getStartDate().getTime() - localCurrentDate.getTime())
                        / Constants.ONE_DAY;
    ...
    public static boolean isVpaEnabled() {
        return com.archibus.service.Configuration.getActivityParameterInt(
            "AbWorkplaceReservations", "ApplyVpaRestrictions", 1) == 1;
    }
