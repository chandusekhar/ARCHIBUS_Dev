...
public class ResourceAllocationDataSource extends AbstractAllocationDataSource<ResourceAllocation>
    ...
    public ResourceAllocation save(final ResourceAllocation bean) {
        ...
        final String sql = "INSERT INTO reserve_rs "
                + " (res_id, resource_id, quantity, bl_id, fl_id, rm_id, date_start, time_start, time_end) "
                + " SELECT ${parameters['reserveId']}, resource_id, ${parameters['quantity']}, "
    ...
    public void update(final ResourceAllocation bean) {
        ...
        final String sql = "UPDATE reserve_rs SET resource_id = ${parameters['resourceId']}, "
