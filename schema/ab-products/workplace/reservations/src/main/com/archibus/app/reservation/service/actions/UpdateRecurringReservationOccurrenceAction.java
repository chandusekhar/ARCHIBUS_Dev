 ...
 * @since 22.1
 */
public class UpdateRecurringReservationOccurrenceAction extends
        SaveRecurringReservationOccurrenceAction {
     ...
     */
    public UpdateRecurringReservationOccurrenceAction(
    ...
    protected RoomReservation handleActualOccurrence(final TimePeriod timePeriod,
        ...
        ReservationUtils.convertToLocalTime(recurringReservation, this.getLocalTimeZone());
         ...
         * later processing.
         */
        recurringReservation.setCreatedReservations(this.existingReservations
            .remove(occurrenceIndex));
