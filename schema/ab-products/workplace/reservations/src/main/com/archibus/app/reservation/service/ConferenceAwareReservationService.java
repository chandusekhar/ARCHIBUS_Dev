 ...
 *
 */
public class ConferenceAwareReservationService extends ReservationService implements
        IConferenceAwareReservationService {
        ...
        if (roomReservation == null) {
            ...
            for (final RoomReservation confCallReservation : confCallReservations) {
                ...
                if (StringUtil.notNullOrEmpty(timeZone)) {
                    ReservationUtils.convertToTimeZone(roomReservation, timeZone);
                }
                break;
            }
        }
    ...
    public List<RoomReservation> saveFullRecurringReservation(final RoomReservation reservation,
        ...
        /*
         * Here we don't want to update reservations with a specific parent id. We need the primary reservation
         * on each occurrence regardless of parent id. Hence pass null as the parent id.
         */
    ...
    public void saveFullReservation(final IReservation reservation) {
        if (reservation.getConferenceId() != null) {
            final List<RoomReservation> confCallReservations =
                    this.reservationDataSource.getByConferenceId(reservation.getConferenceId(),
                        true);
    ...
    private void updateLinkedReservations(final IReservation reservation,
        ...
        if (StringUtil.isNullOrEmpty(reservation.getTimeZone())) {
            reservation.setTimeZone(TimeZoneConverter.getTimeZoneIdForBuilding(reservation
                .determineBuildingId()));
        }
