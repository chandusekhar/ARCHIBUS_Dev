...
public final class ReservationUtils {
    ...
    public static RoomReservation getPrimaryOccurrence(
            final Map<Integer, List<RoomReservation>> mappedReservations, final int occurrenceIndex) {
    ...
    public static void convertToLocalTime(final RoomReservation reservation,
        ...
        if (StringUtil.notNullOrEmpty(reservation.getTimeZone())) {
            ReservationUtils.convertToTimeZone(reservation, localTimeZone);
     ...
     */
    public static void convertToTimeZone(final RoomReservation reservation, final String timeZoneId) {
        reservation.setTimePeriod(ReservationUtils.getTimePeriodInTimeZone(reservation, timeZoneId));
    }
    ...
    public static TimePeriod getTimePeriodInTimeZone(final IReservation reservation,
        ...
        if (timeZoneId.equals(reservation.getTimeZone())) {
            ...
            startDateTime =
                    TimeZoneConverter.calculateDateTime(reservation.getStartDateTime(),
                        reservation.getTimeZone(), timeZoneId);
            endDateTime =
                    TimeZoneConverter.calculateDateTime(reservation.getEndDateTime(),
                        reservation.getTimeZone(), timeZoneId);
        }
    ...
    public static TimePeriod getUtcTimePeriodForDate(final RoomReservation reservation,
        ...
        if (TimePeriod.clearTime(reservation.getStartDate()).equals(date)) {
            ...
            final int durationInMinutes =
                    (int) (reservation.getEndDateTime().getTime() - reservation.getStartDateTime()
                        .getTime()) / TimePeriod.MINUTE_MILLISECONDS;
