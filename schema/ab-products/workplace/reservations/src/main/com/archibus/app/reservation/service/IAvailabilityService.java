...
public interface IAvailabilityService {
     ...
     * @param date the date to get availability info for
     ...
     */
    Map<String, AttendeeAvailability> findAttendeeAvailability(final IReservation reservation,
            final Date date, final TimeZone requestedTimeZone, final String userEmail,
