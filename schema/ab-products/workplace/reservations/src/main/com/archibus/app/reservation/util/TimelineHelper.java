...
public final class TimelineHelper {
    ...
    public static JSONObject createTimeline() {
        ...
        retrieveTimemarks(context, timeline, minorSegments);
    ...
    public static JSONObject createAttendeeCalendarEvent(final JSONObject timeline,
        ...
        event.put(JSON_COLUMN_START, TimelineHelper.getTimeColumn(timelineStartHour, minorSegments,
            EventHandlerBase.getTimeValue(context, startTime), maxTimemarksColumn, false));
        event.put(JSON_COLUMN_END, TimelineHelper.getTimeColumn(timelineStartHour, minorSegments,
            EventHandlerBase.getTimeValue(context, endTime), maxTimemarksColumn, true) - 1);
    ...
    public static JSONObject createRoomArrangementResource(final JSONObject timeline,
        ...
        int dayEndColumn = getTimeColumn(timelineStartHour, minorSegments,
            roomArrangement.getDayEnd(), maxTimemarksColumn, false);
    ...
    private static Integer getTimelineHourParam(final EventHandlerContext context,
        ...
        final String errMessage = EventHandlerBase.localizeMessage(context, ACTIVITY_ID,
            "LOADTIMELINE_WFR", "INVALIDPARAMETERERROR", null);
    ...
    private static void retrieveTimemarks(final EventHandlerContext context,
            final JSONObject timeline, final int minorSegments) {
        ...
        for (int hour = timelineStartHour; hour < timelineEndHour; hour++) {
            ...
            final String dateTimeLabel = EventHandlerBase.formatFieldValue(context, time,
                TIME_TYPENAME, TIMELINE_TIME_FIELDNAME, true);
            ...
            for (int segment = 1; segment < minorSegments; segment++) {
                ...
                final String minorTimeLabel = EventHandlerBase.formatFieldValue(context, tMinor,
                    TIME_TYPENAME, TIMELINE_TIME_FIELDNAME, true);
        ...
        timeline.put("dateTimeEndLabel", EventHandlerBase.formatFieldValue(context, endTime,
            TIME_TYPENAME, TIMELINE_TIME_FIELDNAME, true));
    }
}
