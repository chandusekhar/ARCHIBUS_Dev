...
public interface IReservation extends ITimePeriodBased {
     ...
     */
    void setRecurringDateModified(final int recurringDateModified);
     ...
     */
    void setRecurringRule(final String recurringRule);
     ...
     */
    void setOccurrenceIndex(final int occurrenceIndex);
     ...
     */
    void setParentId(final Integer parentId);
     ...
     */
    void setHtmlComments(final String htmlComments);
}
