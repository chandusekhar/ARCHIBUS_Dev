...
public class LocationQueryHandler {
     ...
     */
    private void handleLocationHierarchy(final LocationQuery query, final LocationQueryResult result) {
    ...
    public List<RoomArrangement> findAvailableRooms(final RoomReservation reservation,
        ...
        if (recurrence == null) {
            roomArrangements =
                    this.reservationService.findAvailableRooms(reservation, capacity, false,
                        resourceStandards, allDayEvent, Constants.TIMEZONE_UTC);
        } else {
            roomArrangements =
