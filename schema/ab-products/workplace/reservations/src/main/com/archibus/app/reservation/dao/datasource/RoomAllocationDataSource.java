...
public class RoomAllocationDataSource extends AbstractAllocationDataSource<RoomAllocation>
    ...
    public RoomAllocation save(final RoomAllocation bean) {
        ...
        final String sql = "INSERT INTO reserve_rm "
                + " (res_id, bl_id, fl_id, rm_id, config_id, rm_arrange_type_id, date_start, time_start, time_end) "
                + " SELECT ${parameters['reserveId']}, bl_id, fl_id, rm_id, config_id, rm_arrange_type_id, "
                + " ${parameters['startDate']}, ${parameters['startTime']}, ${parameters['endTime']} "
    ...
    public void update(final RoomAllocation bean) {
        ...
        final String sql = "UPDATE reserve_rm SET bl_id = ${parameters['buildingId']}, "
