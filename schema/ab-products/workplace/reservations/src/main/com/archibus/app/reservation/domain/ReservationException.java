...
public class ReservationException extends ExceptionBase {
    ...
    public ReservationException(final String message, final Class<?> clazz) {
        super(EventHandlerBase.localizeString(ContextStore.get().getEventHandlerContext(), message,
            clazz.getName()));
    ...
    public ReservationException(final String message, final Class<?> clazz, final Object... args) {
        super(MessageFormat.format(EventHandlerBase.localizeString(
            ContextStore.get().getEventHandlerContext(), message, clazz.getName()), args));
        this.setForUser(true);
    }
}
