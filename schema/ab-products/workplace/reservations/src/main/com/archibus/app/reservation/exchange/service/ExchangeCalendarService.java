...
public class ExchangeCalendarService implements ICalendarService {
    ...
    public void updateAppointmentOccurrence(final IReservation reservation,
        ...
        if (appointment == null) {
            ...
            final String localizedMessage = ReservationsContextHelper.localizeString(
                OCCURRENCE_NOT_FOUND, ExchangeCalendarService.class, reservation.getReserveId());
        ...
        try {
            if (appointment.isNew()) {
                ...
                throw new SeriesNotFoundException(
                    ...
                    ExchangeCalendarService.class, reservation.getParentId());
            } else {
    ...
    private void updateAppointmentOccurrences(final RoomReservation reservation,
        ...
        if (!failedReservationIds.isEmpty()) {
            ...
            throw new CalendarException(
                ...
                ExchangeCalendarService.class, failedReservationIds.size());
        }
    }
