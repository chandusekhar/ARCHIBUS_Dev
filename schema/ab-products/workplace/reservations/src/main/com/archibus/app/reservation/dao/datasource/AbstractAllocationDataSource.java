...
public abstract class AbstractAllocationDataSource<T extends AbstractAllocation>
     ...
     */
    protected abstract IReservable getReservable(final T allocation);
    ...
    protected List<DataRecord> getAllocationRecords(final Date startDate, final Date endDate,
        ...
        if (startDate != null) {
            dataSource.addRestriction(
                Restrictions.gte(this.tableName, Constants.DATE_START_FIELD_NAME, startDate));
        }
        if (endDate != null) {
            dataSource.addRestriction(
    ...
    protected void executeSql(final DataSource dataSource, final String sql) {
        ...
        EventHandlerBase.executeDbSql(this.eventHandlerContext, this.mainTableName, formattedSql,
            true);
    }
    ...
    protected int getPrimaryKey(final Map<String, Object> values, final String fieldName)
        ...
        final List<DataRecord> records =
                EventHandlerBase.retrieveDbDataRecords(this.eventHandlerContext, sql, null,
                    this.getDbFieldsForPrimaryKeysAsMap(), 1, null, null);
