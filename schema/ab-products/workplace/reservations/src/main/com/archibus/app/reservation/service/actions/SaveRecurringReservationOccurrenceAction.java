...
public class SaveRecurringReservationOccurrenceAction implements
        AbstractIntervalPattern.ModifiedOccurrenceAction {
    ...
    protected RoomReservation handleActualOccurrence(final TimePeriod timePeriod,
        ...
        ReservationUtils.convertToLocalTime(recurringReservation, this.localTimeZone);
    ...
    protected boolean isRoomAvailable(final RoomReservation occurrence) {
        ...
        return !this.roomArrangementDataSource.findAvailableRooms(reservationForCheck, null, false,
            null, false, false).isEmpty();
    }
