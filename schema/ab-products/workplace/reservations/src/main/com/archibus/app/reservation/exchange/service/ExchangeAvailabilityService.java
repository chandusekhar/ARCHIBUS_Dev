 ...
 * @since 21.2
 */
public class ExchangeAvailabilityService implements IAvailabilityService {
    ...
    public Map<String, AttendeeAvailability> findAttendeeAvailability(
        ...
        cal.setTime(date);
        cal.add(Calendar.MILLISECOND, -requestedTimeZone.getOffset(date.getTime()));
        ...
        ServiceResponseCollection<microsoft.exchange.webservices.data.AttendeeAvailability> results;
        try {
            ...
            // CHECKSTYLE:ON
            // @translatable
            throw new CalendarException("Error retrieving attendee availability",
                ExchangeAvailabilityService.class, exception);
        }
