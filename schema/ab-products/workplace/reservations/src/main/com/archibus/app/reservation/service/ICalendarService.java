...
public interface ICalendarService {
     ...
     * @throws ExceptionBase translated exception
     */
    void updateAppointmentOccurrence(final IReservation reservation,
     ...
     *
     * @param reservation the primary updated reservation, containing all updated occurrences
     * @param originalReservations the corresponding original reservations
     * @throws ExceptionBase translated exception
     */
    void updateAppointmentSeries(final RoomReservation reservation,
     ...
     * @param notifyOrganizer true to notify the organizer through a separate message
     *
     * @throws ExceptionBase translated exception
     */
