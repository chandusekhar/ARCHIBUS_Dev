var abProbTypeEditCtrl = View.createController('abProbTypeEditCtrl',{
	...
	abProbtypeEdit_detailsPanel_afterRefresh: function(){
		...
		if(this.abProbtypeEdit_detailsPanel.newRecord && this.actionType == 'addSecondTier'){
			var record = this.abProbtypeEdit_ds_1.getRecord("probtype.prob_type ='" + this.firstTierProblemType+"'");
			this.abProbtypeEdit_detailsPanel.setFieldValue("probtype.cost_cat_id", record.getValue("probtype.cost_cat_id"));
		}
	},
