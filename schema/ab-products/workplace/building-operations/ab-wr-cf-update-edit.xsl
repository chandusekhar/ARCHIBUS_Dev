...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">	
	...
	<xsl:template match="/">
		...
		<head>	
			...
			<script language="JavaScript" src="#Attribute%//@relativeFileDirectory%/ab-wr-cf-update-edit.js"><xsl:value-of select="$whiteSpace"/></script>
							...
							<!-- edit part -->
								<tr>
									<td>
										...
										<input type="hidden" size="20" name="wrcf.date_assigned" VALUE="{$str_date_assigned}"/>

										<xsl:variable name="str_time_assigned" select="/*/afmTableGroup/dataSource/data/records/record/@wrcf.time_assigned"/>
										<INPUT type="hidden" size="20" id="wrcf.time_assigned" name="wrcf.time_assigned" VALUE="{$str_time_assigned}"/> 
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td>
										...
										<input class="inputField" type="text" name="wrcf.hours_straight" value="{$str_hours_straight}" onchange='validationInputs("{$afmInputsForm}", "wrcf.hours_straight")' onblur='validationInputs("{$afmInputsForm}", "wrcf.hours_straight")'/>
									</td>
								</tr>
								<tr>
									<td  class="inputFieldLabel" align="left" >
									...
									<td>
										...
										<input class="inputField" type="text" name="wrcf.hours_over" value="{$str_hours_over}" onchange='validationInputs("{$afmInputsForm}", "wrcf.hours_over")' onblur='validationInputs("{$afmInputsForm}", "wrcf.hours_over")'/>
									</td>
								</tr>
								<tr>
									<td  class="inputFieldLabel" align="left" >
