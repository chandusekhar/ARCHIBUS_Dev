...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/">
		...
		<head>
			...
			<!-- script language="JavaScript" src="#Attribute%//@relativeFileDirectory%/ab-wr-update-edit-form.js"><xsl:value-of select="$whiteSpace"/></script-->
		...
		<body class="body" leftmargin="0" rightmargin="0" topmargin="0" bottomMargin="0">
			...
			<!-- record -->
			<xsl:variable name="hasAnyRecord">
				<xsl:choose>
					<xsl:when test="$firstTgrpNode[@addNew='false']">true</xsl:when>
	...
	<!-- customized part -->
	<xsl:include href="ab-wr-update-edit.xsl" />
