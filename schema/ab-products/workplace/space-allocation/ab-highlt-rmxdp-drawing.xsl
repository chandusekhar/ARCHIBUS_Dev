<?xml version="1.0"?>
<!-- ab-highlt-rmxdp-drawing.xsl -->
<!-- XSLT for ab-highlt-rmxdp-drawing.axvw -->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">

  <!-- constants.xsl which contains constant XSLT variables -->
  <xsl:import href="../../../ab-system/xsl/constants.xsl" />

  <!-- The layer containing the room standard highlights is Z-RMXDP-HL -->
  ...
  <xsl:variable name="additionalLayers">
    ...
    <xsl:if test="$isDynamicHighlights!='true'">Z-RMXDP-HL;</xsl:if>
  </xsl:variable>
