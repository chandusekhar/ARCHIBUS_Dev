...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/">
		...
		<head>
			...
			<script language="JavaScript" src="#Attribute%//@relativeFileDirectory%/ab-rm-change-dp-rem-edit.js">
				<xsl:value-of select="$whiteSpace"/>
			</script>
		...
		<body onload="refreshDrawingFrame()" class="body" leftmargin="0" rightmargin="0" topmargin="0" bottomMargin ="0">
