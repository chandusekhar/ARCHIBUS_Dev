<?xml version="1.0"?>
<!-- xslt to handle ab-regulation-authority-edit.axvw-->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/">
		...
		<head>
			...
			<!-- custom actions -->
			<script language="JavaScript" src="#Attribute%//@relativeFileDirectory%/ab-reg-authority-edit.js"><xsl:value-of select="$whiteSpace"/></script>

			<!-- Tell javascript whether this is an add new action -->
			<script language="JavaScript">
				var bAddNew = false;
				<xsl:if test="/afmXmlView/afmTableGroup[@addNew='true']">
					var bAddNew = true;
				</xsl:if>
			</script>
		...
		<body class="body" leftmargin="0" rightmargin="0" topmargin="0" bottomMargin="0" onLoad="setupPage();">
	...
	<xsl:include href="../../../ab-system/xsl/edit-forms/edit-forms.xsl" />
</xsl:stylesheet>
