...
<ab:view version="2.0" showLoadProgress="true">
	<ab:title translatable="true">Edit Multiple - Employee Move</ab:title>
	...
	<ex:multiForm id="form_abMoGroupListEditMultiple" dataSource="ds_abMoGroupListEditMultiple" columns="13" labelsPosition="top">
		...
		<ab:field table="mo" name="em_id" readOnly="true">
			<ab:title translatable="true">Employee</ab:title>
		</ab:field>
