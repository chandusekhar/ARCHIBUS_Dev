var addEditDocController = View.createController('addEditDocController',{
	docId:null,
	itemId:null,
	itemStd:null,
//	itemType:null,
	...
	addEditDoc_onSave: function(){
		...
		if(this.docId == null){
			record = new Ab.data.Record({
				...
				'docs_assigned.eq_id':((this.itemId != null) ? this.itemId : null)
			}, true);
			...
			restriction.addClause('docs_assigned.eq_id', record.getValue('docs_assigned.eq_id'), '=');
