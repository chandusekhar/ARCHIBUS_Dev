 ...
 *
 */
public class ProjectService extends JobBase {
    /**
     * Fields array.
     */
    ...
    public String cascadeAllTaskDependencies() throws ExceptionBase {
        final ProjGanttService projectGanttService = new ProjGanttService();
        return projectGanttService.cascadeAllTaskDependencies();
    }
     ...
     * @throws ExceptionBase exception
     */
    public String cascadeTaskDependencies(final int activityLogId) throws ExceptionBase {
        final ProjGanttService projectGanttService = new ProjGanttService();
        return projectGanttService.cascadeTaskDependencies(activityLogId);
    }
    /**
