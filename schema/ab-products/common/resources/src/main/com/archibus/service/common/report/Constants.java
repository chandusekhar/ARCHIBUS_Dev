...
public final class Constants {
     ...
     */
    public static final String[] STANDARD_SCALE_IMPERIAL = { "1", "3/4", "1/2", "3/8", "1/4",
            "3/16", "1/8", "3/32", "1/16", "1/32", "1/64", "1/128" };
    
    /**
     * Constant: Metric standard scale names for displaying.
     */
    public static final String[] STANDARD_SCALE_METRIC = { "1:1", "1:2", "1:5", "1:10", "1:20",
            "1:25", "1:50", "1:100", "1:200", "1:250", "1:500", "1:1000", "1:2000" };
    
    // CHECKSTYLE:OFF Justification: Suppress
    /**
     * Constant: Imperial standard scale fractions for calculation .
     */
    public static final double[] STANDARD_SCALES_FACTORS_IMPERIAL = { 12.00, 16.00, 24.00, 32.00,
            48.00, 64.00, 96.00, 128.00, 192.00, 384.00, 768.00, 1536.00 };
    
    /**
     * Constant: Metric standard scale fractions for calculation .
     */
    public static final double[] STANDARD_SCALES_FACTORS_METRIC = { 100.00, 200.00, 500.00,
            1000.00, 2000.00, 2500.00, 5000.00, 10000.00, 20000.00, 25000.00, 50000.00, 100000.00,
            200000.00 };
