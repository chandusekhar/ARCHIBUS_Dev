 ...
 * <p>
 *
 * <li>Metric Name: fin_anlys_RemainingMortgage_an
 * <li>Bean Name : fin_anlys_RemainingMortgage_an
 *
 * <p>
 *
 ...
 * @since 23.1
 */
public class RemainingMortgage implements MetricProvider {

    /**
     * Constant.
     */
    private static final String COSTCATEGORY_PRINCIPALBUILDING =
            "AbRPLMStrategicFinancialAnalysis-CostCategory_PrincipalBuilding";

    /**
     * Constant.
     */
    private static final String COSTCATEGORY_INTERESTBUILDING =
            "AbRPLMStrategicFinancialAnalysis-CostCategory_InterestBuilding";

    /**
     * Constant.
     */
    private static final String COSTCATEGORY_PRINCIPALPROPERTY =
            "AbRPLMStrategicFinancialAnalysis-CostCategory_PrincipalProperty";

    /**
     * Constant.
     */
    private static final String COSTCATEGORY_INTERESTPROPERTY =
            "AbRPLMStrategicFinancialAnalysis-CostCategory_InterestProperty";
    ...
    public void calculateValues(final FinancialAnalysisParameter financialParameter,
            final Date dateFrom, final Date dateTo) {
        this.errorMessage = "";
        List<String> costCategories = new ArrayList<String>();
        if (AssetType.BUILDING.equals(financialParameter.getAssetType())) {
            costCategories =
                    ActivityParameterUtils.getAllCostCategories(COSTCATEGORY_PRINCIPALBUILDING);
            costCategories
                .addAll(ActivityParameterUtils.getAllCostCategories(COSTCATEGORY_INTERESTBUILDING));
        } else if (AssetType.PROPERTY.equals(financialParameter.getAssetType())) {
            costCategories =
                    ActivityParameterUtils.getAllCostCategories(COSTCATEGORY_PRINCIPALPROPERTY);
            costCategories
                .addAll(ActivityParameterUtils.getAllCostCategories(COSTCATEGORY_INTERESTPROPERTY));
        }
