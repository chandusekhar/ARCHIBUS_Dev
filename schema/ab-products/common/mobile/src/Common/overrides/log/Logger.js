/**
 * Overrides the Ext.log.Logger#log function
 * @since 22.1
 * @author Jeff Martin
 */
Ext.define('Common.overrides.log.Logger', {
                ...
                log: function(message, priority, callerId) {
                    ...
                    for (i in writers) {
                        if (writers.hasOwnProperty(i)) {
                            /* Override */
                            /* Check if the write function is available. The writer will not exist when changing the
                               state of the Logger writers.
                            */
                            if(writers[i].write) {
