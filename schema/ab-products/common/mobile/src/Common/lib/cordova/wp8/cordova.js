...
// it may be called before any cordova JS is ready.
        if (window._nativeReady) {
            console.log('---> cordova native ready. onNativeReady.fire')
...
// The delay allows the attached modules to be defined before the plugin loader looks for them.
        ...
        channel.join(function () {
            ...
            console.log('----> cordova fire onCordovaReady');
            ...
            // side.
            channel.join(function () {
                console.log('--> cordova fire device ready');
...
// Exported for testing.
        exports.injectScript = function (url, onload, onerror) {
            ...
            console.log('--> cordova plugins onLoad()');
            onload();
        };
...
// Overridden by Android, BlackBerry 10 and iOS to populate fsMap.
    ...
    cordova.define("com.brodysoft.sqlitePlugin.SQLitePlugin", function (require, exports, module) {
        (function () {
