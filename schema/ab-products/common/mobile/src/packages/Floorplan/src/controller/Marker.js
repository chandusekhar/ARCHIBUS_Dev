/**
 * Marker controller. This controller should be used along with the {@link Floorplan.view.FloorPlan} view
 * @since 23.1
 * @author Emily Li
 */
Ext.define('Floorplan.controller.Marker', {
    ...
    z_DELETE_MESSAGE: LocaleManager.getLocalizedString('Are you sure you want to delete this item?', 'Floorplan.controller.Marker'),
    z_EDIT_MESSAGE: LocaleManager.getLocalizedString('Edit', 'Floorplan.controller.Marker'),
    ...
    setTranslatableStrings: function () {
        this.getSvgControl().z_DELETE_MESSAGE = this.z_DELETE_MESSAGE;
        this.getSvgControl().z_EDIT_MESSAGE = this.z_EDIT_MESSAGE;
