Ext.define('SpaceBook.controller.Redline', {
    ...
    config: {
        ...
        redlineStoreId: 'roomSurveyStore',

        roomPromptFieldConfig: {
            title: LocaleManager.getLocalizedString('Select Room', 'SpaceBook.controller.Documents'),
            label: '',
            ...
            displayFields: [
                {
                    name: 'bl_id',
                    title: LocaleManager.getLocalizedString('Building Code', 'SpaceBook.controller.Documents')
                },
                {
                    name: 'fl_id',
                    title: LocaleManager.getLocalizedString('Floor Code', 'SpaceBook.controller.Documents')
                },
                {
                    name: 'rm_id',
                    title: LocaleManager.getLocalizedString('Room Code', 'SpaceBook.controller.Documents')
                },
                {
                    name: 'rm_std',
                    title: LocaleManager.getLocalizedString('Room Standard', 'SpaceBook.controller.Documents')
                }
            ],
            displayTemplate: {
                phone: '<div class="x-phone-prompt"><span class="prompt-label">' +
                LocaleManager.getLocalizedString('Building:', 'SpaceBook.controller.Documents') +
                '</span><span>{bl_id}</span></div>' +
                '<div class="x-phone-prompt"><span class="prompt-label">' +
                LocaleManager.getLocalizedString('Floor:', 'SpaceBook.controller.Documents') +
                '</span><span>{fl_id}</span></div>' +
                '<div class="x-phone-prompt"><span class="prompt-label">' +
                LocaleManager.getLocalizedString('Room:', 'SpaceBook.controller.Documents') +
                '</span><span>{rm_id}</span></div>' +
                '<div class="x-phone-prompt"><span class="prompt-label">' +
                LocaleManager.getLocalizedString('Standard:', 'SpaceBook.controller.Documents') +
    ...
    onSaveImage: function () {
        var me = this,
            ...
            store = Ext.getStore('roomSurveyStore'),
