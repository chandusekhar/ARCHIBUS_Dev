...
Mobile.control.fr = {
    ...
    validationMessages: [
        {key1: 'PRESENCE', key2: 'must be present', value: 'doit être renseigné(e)'},
        {key1: 'LENGTH', key2: 'is the wrong length', value: 'a un longueur incorrecte'},
        {key1: 'FORMAT', key2: 'is the wrong format', value: 'a un format incorrect'},
        {key1: 'INCLUSION', key2: 'is not included in the list of acceptable values', value: 'ne figure pas dans la liste des valeurs acceptables'},
        {key1: 'EXCLUSION', key2: 'is not an acceptable value', value: 'n’est pas une valeur acceptable'},
        {key1: 'EMAIL', key2: 'is not a valid email address', value: 'n’est pas une adresse e-mail valide'}
    ]
};
