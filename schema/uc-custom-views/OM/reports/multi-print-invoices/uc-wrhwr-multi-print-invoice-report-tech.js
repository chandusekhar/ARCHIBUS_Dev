// CHANGE LOG
// 2016/03/29 - MSHUSSAI - Developed new JS file to add code to Print Work Request with Technician Comments
...
var printCtrl = View.createController('printCtrl', {
   ...
   printRow: function(para,rest,list) {
		...
		ds1=this.view.dataSources.get('wrhwrlist_ds10');
		if(rest!=' '){
			...
			ds=View.dataSources.get('wrhwrlist_ds10');
	...
	if(result.code == 'executed'){
		...
		for(var j=0;j<results.length;j++){
            ...
            if (record['wrhwr.work_team_id'] != 'FLEET' ) {
				...
				//MSHUSSAI - ADD THE CF_NOTES VISIBILITY TO HERE
