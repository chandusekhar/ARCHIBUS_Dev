...
function onCrossTableClick(obj){
    ...
    var trClause = restrictionObj.findClause("wr.work_team_id");
    if (trClause != null) {
        restriction += " AND work_team_id = '"+trClause.value.replace(/'/g,"''")+"'";
    }
    ...
    if (periodClause != null) {
        ...
        switch (clauseValue) {
        case '30+ Days':
            restriction += " AND DATEDIFF(d, wr.date_requested, GETDATE()) > 30";
