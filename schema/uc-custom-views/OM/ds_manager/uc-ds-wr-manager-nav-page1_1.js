...
var wrManagerNav1Controller = View.createController('wrManagerNav1Controller', {
    ...
    afterInitialDataFetch: function() {
        ...
        var cfWT = UC.Data.getDataValue('cf', 'work_team_id', "email='"+emEmail.replace(/'/g,"''")+"'");
		var cfName = UC.Data.getDataValue('cf', 'cf_id', "email='"+emEmail.replace(/'/g,"''")+"'");
        this.nav_console.setFieldValue('wrhwr.work_team_id', cfWT);
...
function wrhwr_console_applyRestriction() {
    ...
    */
    ...
    if (work_team_id != "") {
        restriction += " AND wrhwr.work_team_id = "+literalOrNull(work_team_id);
    }
