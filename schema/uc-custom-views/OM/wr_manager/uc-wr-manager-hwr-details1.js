...
var hwrDetailsController = View.createController('hwrDetailsController', {
	...
	afterInitialDataFetch: function() {
		...
		this.pjhaReportGrid.refresh("wr_id='" + wr_id + "'");
		this.wrcfTimeReportGrid.refresh("wr_id='" + wr_id + "'");
		this.wrtlReportGrid.refresh("wr_id='" + wr_id + "'");
		this.wrOtherReportGrid.refresh("wr_id='" + wr_id + "'");
		this.audit_info.refresh("wr_id='" + wr_id + "'");
	},
