...
function selectVnAcId() {
	...
	var rest = "bill_type.activity_id = 'abRiskES' and not exists (select 1 from bill_type p where p.parent=bill_type.bill_type_id)";
	rest += vnAc_rest;
	View.selectValue('editVnAc_form', 'Stream',
		['vn_ac.vn_ac_id'],
		'bill_type',
...
function custSave() {
	...
	var rest = "bill_type.bill_type_id='"+vnAcId+"' AND bill_type.activity_id='ABRiskES' ";
