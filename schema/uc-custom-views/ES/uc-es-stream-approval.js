var resController = View.createController('resController', {
  ...
  afterInitialDataFetch: function(){
	...
	openDetails: function(row){
		...
		View.openDialog('uc-es-stream-upd.axvw', {'bill.bill_id':billId,'bill.vn_id':vnId}, false, {
			width: 850,
			height: 750,
			closeButton: false,
			mode: 'editRecord'
	...
	bulkUpdate: function(status, msg){
		...
		if (msg !=""){
			...
			alert("Send email here - The Following Material Bills were rejected: " + billList + ".  " + msg)
