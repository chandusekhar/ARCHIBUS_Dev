			...
			if (button=='yes') {
				...
				try {
					...
					if (status == 'AA') {
						...
						var recordValues = this.getWorkflowRecordValues(form);
	...
	wrStartWork: function() {
		...
		try {
			...
			if (status == 'AA') {
				...
				var result = {};
				result = Workflow.callMethod('AbBldgOpsOnDemandWork-WorkRequestService-updateWorkRequestStatus', recordValues, newStatus);
			}
