...
{
	View.panels.get('changeRequestorSelect').refresh();
	View.panels.get('changeRequestorSelect').showInWindow({});
/*
	View.selectValue(
        'wr_create_details',
		'Select Requestor',
		['activity_log.requestor','activity_log.phone_requestor'],
		'uc_d_person_ps',
		['uc_d_person_ps.person_eid', 'uc_d_person_ps.person_campus_phone'],
		['uc_d_person_ps.person_eid', 'uc_d_person_ps.person_campus_phone', 'uc_d_person_ps.person_first_name', 'uc_d_person_ps.person_last_name'],
		"person_eid <> ''",
		null,
		false,
		true,
