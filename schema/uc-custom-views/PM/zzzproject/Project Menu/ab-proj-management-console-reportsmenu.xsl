 ...
 <xsl:template match="/">
	<html>
	    ...
	    <!-- LinkingCSS in common.xsl includes the default style sheets -->
			<link rel="stylesheet" type="text/css" href="#Attribute%//@relativeFileDirectory%/ab-proj-management-console.css"/>
	    <xsl:call-template name="LinkingCSS" />
	    <script language="JavaScript" src="{$abSchemaSystemJavascriptFolder}/common.js"><xsl:value-of select="$whiteSpace" /></script>
	    <script language="JavaScript" src="#Attribute%//@relativeFileDirectory%/ab-proj-management-console-tabmenu.js"><xsl:value-of select="$whiteSpace" /></script>
		</head>
