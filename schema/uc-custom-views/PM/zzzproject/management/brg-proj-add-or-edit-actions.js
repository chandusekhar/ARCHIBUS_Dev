...
/**********************************************************
 ab-proj-add-or-edit-actions.js
...
function setPanelTitle()
{
	...
	var projectId = "";
	projectId = southPanel.restriction['project.project_id'];
	var southFrame = getFrameObject(parent,'southFrame');
	var titleTD = southFrame.$('_title'); 
...
{
	var southPanel= AFM.view.View.getControl('southFrame','southPanel');
	strDestProjectId = southPanel.restriction['project.project_id'];
	if (strDestProjectId != "")
	{
