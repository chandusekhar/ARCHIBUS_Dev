...
{
	var ruleName = "AbProjectManagement-ProjectManagementService-calcActivityLogDateSchedEndForWorkPkg";

	if (work_pkg_id == "") ruleName = "AbProjectManagement-ProjectManagementService-calcActivityLogDateSchedEndForProject";	
