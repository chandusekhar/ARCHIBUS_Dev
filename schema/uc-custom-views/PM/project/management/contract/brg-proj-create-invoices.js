...
function autofillInfo() {
    var panel = View.panels.get("projCreateInvoicesForm");
    var projectId = panel.getFieldValue("invoice.project_id");
    var intNum = BRG.Common.getDataValue("project", "int_num", "project_id = "+BRG.Common.literalOrNull(projectId, true));

    panel.setFieldValue("invoice.int_num", intNum);
}