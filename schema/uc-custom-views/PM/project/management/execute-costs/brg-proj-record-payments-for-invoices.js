...
function actLogSelvalWithRestriction()
{
    ...
    View.selectValue('projRecordPaymentsForInvoicesForm','Action Item ID',['invoice_payment.activity_log_id'],'activity_log',['activity_log.activity_log_id'],['activity_log.activity_log_id','activity_log.work_pkg_id','activity_log.action_title','activity_log.description','activity_log.activity_type'],restriction);
}