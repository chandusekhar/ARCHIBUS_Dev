...
var projectManagerController = View.createController('projectManagerController', {
	...
	consolePanel_onShow: function(){
		...
		setTimeout(function() {
			...
			var cfi_num = projectManagerController.consolePanel.getFieldValue('project.cfi_num');
			var incl_noncfi = projectManagerController.consolePanel.getFieldValue('project.incl_noncfi');
			...
			if (cfi_num != "") { restriction = restriction + " AND project.cfi_num = "+projectManagerController.literalOrNull(cfi_num); }
			if (incl_noncfi != "") { restriction = restriction + " AND project.incl_noncfi = "+projectManagerController.literalOrNull(incl_noncfi); }
