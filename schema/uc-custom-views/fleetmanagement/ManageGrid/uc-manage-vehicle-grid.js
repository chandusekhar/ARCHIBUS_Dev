...
*/
	...
	schedulegrid_onCreateWRButton: function(row, action) {
		...
		View.openDialog('uc-pm-request-create-fleet.axvw', '', true, 
			{
				width: 900,
				height: 450,
...
function getEquipmentDetails() {
	...
	*/
	...
	if(vehicle_details.getFieldValue("vehicle.cost_ins_perils")!="" && parseFloat(vehicle_details.getFieldValue("vehicle.cost_ins_perils"))!=0){
	...
	if(vehicle_details.getFieldValue("vehicle.hazmat_types")!="") {
