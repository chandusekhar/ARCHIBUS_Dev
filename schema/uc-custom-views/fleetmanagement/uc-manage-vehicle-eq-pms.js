...
function loadVehAcctCode(acct) {
	...
	$('vac_id_part1').value = bu;
	$('vac_id_part2').value = fund;
	$('vac_id_part3').value = dept;
	$('vac_id_part4').value = account;
	$('vac_id_part5').value = program;
	$('vac_id_part6').value = internal;
	$('vac_id_part7').value = project;
	$('vac_id_part8').value = affiliate;
}
