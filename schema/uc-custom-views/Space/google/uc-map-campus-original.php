...
// array of buildings and floors array["Drawing ID"] = array("Building Display Name", "Lat", "Long", "Building Icon")
		$allBuildings = array();
...
// array of buildings and floors array["Drawing ID"] = array("Floor ID", [floor id...])
...
//popup
			...
			foreach ($floorDataArray as $fKey=>$fValue) {
				print("<font face='Arial'>&middot; <a onmouseover=\\\"this.style.background='#e6e8fa'\\\" onmouseout=\\\"this.style.background='white'\\\" href='/archibus/uc-floor-selector-goog.axvw?bl_id=$bID&fl_id=$fValue'>Floor $fValue</a></font><br>");
			}
			print("\t\t\t</td></tr></table>\");\n");
			print("\t\t});\n");
//hover
...
//			print("\t\tif (lastInfoWindow) {myCloseInfoWindow();}\n");
//			print("\t\tlastInfoWindow = $bID;\n");
//			print("\t\t\tthis.openInfoWindowHtml(\"<font face='Arial'><b>$bName</b><br/>Press for details</font>\");\n");
//			print("\t\t});\n");
//hover out
//			print("\t\tGEvent.addListener($bID, \"mouseout\", function() {\n");
//			print("\t\tlastInfoWindow = $bID;\n");
//			print("\t\t\tmyCloseInfoWindow();\n");
//			print("\t\t});\n");
		}
?>
...
<?php
		...
		print("<select onChange=\"centerZoom(this.value);\" size=10 style=\"width:200px; background-color:#CCD3CC;\">");
		foreach ($allBuildings as $bID=>$values) {
			list($bName, $bLAT, $bLONG, $bIcon) = $values;
