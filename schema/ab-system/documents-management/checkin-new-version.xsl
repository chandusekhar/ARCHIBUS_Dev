...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
        ...
        <xsl:template match="/">
                ...
                <head>
                        ...
                        <script language="JavaScript" src="#Attribute%//@relativeFileDirectory%/checkin-new-version.js"><xsl:value-of select="$whiteSpace"/></script>
                        ...
                        <script language="JavaScript">
                                ...
                                documanager_originalFileName='<xsl:value-of select="//afmTableGroup/records/record/@fileName"/>';
                                ...
                                <tr align="center">
                                        <td colspan="2" align="center">
                                                <table class="bottomActionsTable">
                                                         <tr><td>
                                                                <xsl:variable name="OK" select="//afmAction[@eventName='AbCommonResources-checkinNewVersion']"/>
                                                                <input id="okButton" name="okButton" disabled="1" class="AbActionButtonFormStdWidth" type="button" value="{$OK/title}" title="{$OK/title}" onclick='onOK("{$OK/@serialized}");'/>
