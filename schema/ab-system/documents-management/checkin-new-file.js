...
2005-01-27
*********************************************/
//initialized by checkin-new-file.xsl
...
var documanager_originalFileName = "";
...
function onOK(strSerialized)
{
	...
	if(!okButtonObj.disabled)
	{
		...
		objHiddenForm.action = "dynamic-content.axvw";
...
function gettingRecordsData()
{
	...
	strReturned = strReturned + ' description="'+docmanager_description+'" ';
