...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">	
	...
	<xsl:template match="/">
		...
		<head>	
			...
			<script language="JavaScript" src="#Attribute%//@relativeFileDirectory%/view-definition-form-content-view-analysis-chart-config.js"><xsl:value-of select="$whiteSpace"/></script>
		</head>
			...
			<table align="center" valign="middle" width="100%">
				...
				<tr><td align="center">
					<table  align="center"  width="100%">
						...
						<tr>
							<td class="legendTitle"><span translatable="true">Plot Orientation:</span></td><td><input type="radio" id="VERT" name="Orientation" checked="1"/><span style="font-size:14;font-family:arial,geneva,helvetica,sans-serif" translatable="true">Vertical</span>
							<br/><input type="radio" id="HERZ" name="Orientation"/><span style="font-size:14;font-family:arial,geneva,helvetica,sans-serif" translatable="true">Horizontal</span></td>
						</tr>
						<tr>
