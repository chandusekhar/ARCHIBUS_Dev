...
function ChangeItToActiveItem(tableName, strUrl, strXML, strTarget)
{
	...
	if(previouSelectedNodeImgID != "")
	{
		...
		if(previousImgObj != null)
			...
			previousImgObj.alt = "Item Previously Selected";
			previousImgObj.title = "Item Previously Selected";
	}
    if(tableName != "")
	{
...
//
function loadAddStaffDumpFile()
{
	var strFrame = "detailsFrame";
	var viewFileName = "ab-em-add-or-update-edit-dump.axvw";
	...
	if(objTargetFrame != null)
	{
		...
		objTargetFrame.location.href = viewFileName;
	}
}