<?xml version="1.0"?>
<!-- ab-ex-property-holdings-by-status-pie-top.xsl for ab-ex-property-holdings-by-status-pie-top.axvw-->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:import href="../xsl/constants.xsl" />
  <xsl:variable name="chart_view_name" select="'ab-ex-property-holdings-by-status-pie.axvw'"/>
  <xsl:template match="/">
	<html>
		<title>
		...
		<head>
		    ...
		    <script language="JavaScript" src="#Attribute%//@relativeFileDirectory%/ab-ex-property-holdings-by-status-pie.js">
			<xsl:value-of select="$whiteSpace" />
		    </script>
		</head>
		<!-- svg viewer body -->
